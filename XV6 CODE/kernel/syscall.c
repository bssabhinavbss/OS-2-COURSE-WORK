...
extern uint64 sys_hello(void); // added this
...
[SYS_mkdir]   sys_mkdir,
[SYS_close]   sys_close,
[SYS_hello]   sys_hello, // hello(syscall entry i wrotten here)
[SYS_getpid2] sys_getpid2, //getpid2(syscall entered)
[SYS_getppid] sys_getppid, //getppid adfed here
[SYS_getnumchild] sys_getnumchild,//getnumchild added here
