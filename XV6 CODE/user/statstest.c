...
#define WORK_PAGES   64    // > MAX_FRAMES to guarantee eviction
#define PRESSURE     72
#define HEAVY_PAGES  96
...
//   max = DISK_BLOCKS (2048) + ROTATIONAL_CONST = 2053
static void
...
t9_same_write_volume(void)
{
  ...
  // slightly relaxed check since clock hand interleaving can cause small eviction variation
