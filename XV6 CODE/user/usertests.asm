...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	ba078793          	addi	a5,a5,-1120 # 7bb0 <malloc+0x2678>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	5c450513          	addi	a0,a0,1476 # 5630 <malloc+0xf8>
      74:	40c050ef          	jal	5480 <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	5aa50513          	addi	a0,a0,1450 # 5650 <malloc+0x118>
      ae:	3d2050ef          	jal	5480 <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	5a250513          	addi	a0,a0,1442 # 5668 <malloc+0x130>
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	5ac50513          	addi	a0,a0,1452 # 5688 <malloc+0x150>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	57850513          	addi	a0,a0,1400 # 5670 <malloc+0x138>
     100:	380050ef          	jal	5480 <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	58c50513          	addi	a0,a0,1420 # 5698 <malloc+0x160>
     114:	36c050ef          	jal	5480 <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     186:	53e50513          	addi	a0,a0,1342 # 56c0 <malloc+0x188>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	53450513          	addi	a0,a0,1332 # 56e0 <malloc+0x1a8>
     1b4:	2cc050ef          	jal	5480 <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     260:	4ac50513          	addi	a0,a0,1196 # 5708 <malloc+0x1d0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     274:	498a0a13          	addi	s4,s4,1176 # 5708 <malloc+0x1d0>
     278:	4b09                	li	s6,2
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	43c50513          	addi	a0,a0,1084 # 5718 <malloc+0x1e0>
     2e4:	19c050ef          	jal	5480 <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2f8:	44450513          	addi	a0,a0,1092 # 5738 <malloc+0x200>
     2fc:	184050ef          	jal	5480 <printf>
        exit(1);
     300:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     31e:	43650513          	addi	a0,a0,1078 # 5750 <malloc+0x218>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     332:	42298993          	addi	s3,s3,1058 # 5750 <malloc+0x218>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     36e:	3e650513          	addi	a0,a0,998 # 5750 <malloc+0x218>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     382:	35a58593          	addi	a1,a1,858 # 56d8 <malloc+0x1a0>
     386:	485040ef          	jal	500a <write>
     38a:	4785                	li	a5,1
     38c:	02f50d63          	beq	a0,a5,3c6 <badwrite+0xc0>
    printf("write failed\n");
     390:	00005517          	auipc	a0,0x5
     394:	3e050513          	addi	a0,a0,992 # 5770 <malloc+0x238>
     398:	0e8050ef          	jal	5480 <printf>
    exit(1);
     39c:	4505                	li	a0,1
     39e:	44d040ef          	jal	4fea <exit>
      printf("open junk failed\n");
     3a2:	00005517          	auipc	a0,0x5
     3a6:	3b650513          	addi	a0,a0,950 # 5758 <malloc+0x220>
     3aa:	0d6050ef          	jal	5480 <printf>
      exit(1);
     3ae:	4505                	li	a0,1
     3b0:	43b040ef          	jal	4fea <exit>
    printf("open junk failed\n");
     3b4:	00005517          	auipc	a0,0x5
     3b8:	3a450513          	addi	a0,a0,932 # 5758 <malloc+0x220>
     3bc:	0c4050ef          	jal	5480 <printf>
    exit(1);
     3c0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d0:	38450513          	addi	a0,a0,900 # 5750 <malloc+0x218>
...
00000000000004aa <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4c8:	6ec78793          	addi	a5,a5,1772 # 7bb0 <malloc+0x2678>
     4cc:	638c                	ld	a1,0(a5)
     4ce:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fa:	28aa8a93          	addi	s5,s5,650 # 5780 <malloc+0x248>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58c:	20050513          	addi	a0,a0,512 # 5788 <malloc+0x250>
     590:	6f1040ef          	jal	5480 <printf>
      exit(1);
     594:	4505                	li	a0,1
     ...
     5a2:	20250513          	addi	a0,a0,514 # 57a0 <malloc+0x268>
     5a6:	6db040ef          	jal	5480 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	21c50513          	addi	a0,a0,540 # 57d0 <malloc+0x298>
     5bc:	6c5040ef          	jal	5480 <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     5c2:	229040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     5c6:	00005517          	auipc	a0,0x5
     5ca:	23a50513          	addi	a0,a0,570 # 5800 <malloc+0x2c8>
     5ce:	6b3040ef          	jal	5480 <printf>
      exit(1);
     5d2:	4505                	li	a0,1
     ...
     5e0:	23450513          	addi	a0,a0,564 # 5810 <malloc+0x2d8>
     5e4:	69d040ef          	jal	5480 <printf>
      exit(1);
     5e8:	4505                	li	a0,1
...
00000000000005ee <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60c:	5a878793          	addi	a5,a5,1448 # 7bb0 <malloc+0x2678>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     640:	204b0b13          	addi	s6,s6,516 # 5840 <malloc+0x308>
    ...
    n = write(fds[1], "x", 1);
     ...
     650:	08cb8b93          	addi	s7,s7,140 # 56d8 <malloc+0x1a0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d6:	17650513          	addi	a0,a0,374 # 5848 <malloc+0x310>
     6da:	5a7040ef          	jal	5480 <printf>
      exit(1);
     6de:	4505                	li	a0,1
     ...
     6ec:	17850513          	addi	a0,a0,376 # 5860 <malloc+0x328>
     6f0:	591040ef          	jal	5480 <printf>
      exit(1);
     6f4:	4505                	li	a0,1
     6f6:	0f5040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     6fa:	00005517          	auipc	a0,0x5
     6fe:	10650513          	addi	a0,a0,262 # 5800 <malloc+0x2c8>
     702:	57f040ef          	jal	5480 <printf>
      exit(1);
     706:	4505                	li	a0,1
     708:	0e3040ef          	jal	4fea <exit>
      printf("pipe write failed\n");
     70c:	00005517          	auipc	a0,0x5
     710:	18450513          	addi	a0,a0,388 # 5890 <malloc+0x358>
     714:	56d040ef          	jal	5480 <printf>
      exit(1);
     718:	4505                	li	a0,1
     ...
     726:	18650513          	addi	a0,a0,390 # 58a8 <malloc+0x370>
     72a:	557040ef          	jal	5480 <printf>
      exit(1);
     72e:	4505                	li	a0,1
...
0000000000000734 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     780:	f4450513          	addi	a0,a0,-188 # 56c0 <malloc+0x188>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a4:	f2050513          	addi	a0,a0,-224 # 56c0 <malloc+0x188>
     7a8:	083040ef          	jal	502a <open>
     7ac:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7ae:	4581                	li	a1,0
     7b0:	00005517          	auipc	a0,0x5
     7b4:	f1050513          	addi	a0,a0,-240 # 56c0 <malloc+0x188>
  ...
  write(fd1, "abcdef", 6);
     ...
     7e6:	15658593          	addi	a1,a1,342 # 5938 <malloc+0x400>
     7ea:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81c:	ea850513          	addi	a0,a0,-344 # 56c0 <malloc+0x188>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     850:	08c50513          	addi	a0,a0,140 # 58d8 <malloc+0x3a0>
     854:	42d040ef          	jal	5480 <printf>
    exit(1);
     858:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     864:	09850513          	addi	a0,a0,152 # 58f8 <malloc+0x3c0>
     868:	419040ef          	jal	5480 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86c:	8656                	mv	a2,s5
     86e:	85d2                	mv	a1,s4
     870:	00005517          	auipc	a0,0x5
     874:	09850513          	addi	a0,a0,152 # 5908 <malloc+0x3d0>
     878:	409040ef          	jal	5480 <printf>
    exit(1);
     87c:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     888:	0a450513          	addi	a0,a0,164 # 5928 <malloc+0x3f0>
     88c:	3f5040ef          	jal	5480 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     890:	8656                	mv	a2,s5
     892:	85d2                	mv	a1,s4
     894:	00005517          	auipc	a0,0x5
     898:	07450513          	addi	a0,a0,116 # 5908 <malloc+0x3d0>
     89c:	3e5040ef          	jal	5480 <printf>
    exit(1);
     8a0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8ae:	09650513          	addi	a0,a0,150 # 5940 <malloc+0x408>
     8b2:	3cf040ef          	jal	5480 <printf>
    exit(1);
     8b6:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c4:	0a050513          	addi	a0,a0,160 # 5960 <malloc+0x428>
     8c8:	3b9040ef          	jal	5480 <printf>
    exit(1);
     8cc:	4505                	li	a0,1
...
00000000000008d2 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f2:	09250513          	addi	a0,a0,146 # 5980 <malloc+0x448>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     908:	0a4a0a13          	addi	s4,s4,164 # 59a8 <malloc+0x470>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90c:	00005b17          	auipc	s6,0x5
     910:	0d4b0b13          	addi	s6,s6,212 # 59e0 <malloc+0x4a8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     946:	03e50513          	addi	a0,a0,62 # 5980 <malloc+0x448>
  ...
  if(unlink("small") < 0){
     ...
     976:	00e50513          	addi	a0,a0,14 # 5980 <malloc+0x448>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     99e:	fee50513          	addi	a0,a0,-18 # 5988 <malloc+0x450>
     9a2:	2df040ef          	jal	5480 <printf>
    exit(1);
     9a6:	4505                	li	a0,1
     ...
     9b4:	00850513          	addi	a0,a0,8 # 59b8 <malloc+0x480>
     9b8:	2c9040ef          	jal	5480 <printf>
      exit(1);
     9bc:	4505                	li	a0,1
     ...
     9ca:	02a50513          	addi	a0,a0,42 # 59f0 <malloc+0x4b8>
     9ce:	2b3040ef          	jal	5480 <printf>
      exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9de:	03e50513          	addi	a0,a0,62 # 5a18 <malloc+0x4e0>
     9e2:	29f040ef          	jal	5480 <printf>
    exit(1);
     9e6:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f2:	04a50513          	addi	a0,a0,74 # 5a38 <malloc+0x500>
     9f6:	28b040ef          	jal	5480 <printf>
    exit(1);
     9fa:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a06:	04e50513          	addi	a0,a0,78 # 5a50 <malloc+0x518>
     a0a:	277040ef          	jal	5480 <printf>
    exit(1);
     a0e:	4505                	li	a0,1
...
0000000000000a14 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a32:	04250513          	addi	a0,a0,66 # 5a70 <malloc+0x538>
  ...
  fd = open("big", O_RDONLY);
     ...
     a76:	ffe50513          	addi	a0,a0,-2 # 5a70 <malloc+0x538>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab4:	fc850513          	addi	a0,a0,-56 # 5a78 <malloc+0x540>
     ab8:	1c9040ef          	jal	5480 <printf>
    exit(1);
     abc:	4505                	li	a0,1
     ...
     aca:	fd250513          	addi	a0,a0,-46 # 5a98 <malloc+0x560>
     ace:	1b3040ef          	jal	5480 <printf>
      exit(1);
     ad2:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ade:	fe650513          	addi	a0,a0,-26 # 5ac0 <malloc+0x588>
     ae2:	19f040ef          	jal	5480 <printf>
    exit(1);
     ae6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     afe:	f7650513          	addi	a0,a0,-138 # 5a70 <malloc+0x538>
     ...
     b26:	fbe50513          	addi	a0,a0,-66 # 5ae0 <malloc+0x5a8>
     b2a:	157040ef          	jal	5480 <printf>
        exit(1);
     b2e:	4505                	li	a0,1
     ...
     b3c:	fd050513          	addi	a0,a0,-48 # 5b08 <malloc+0x5d0>
     b40:	141040ef          	jal	5480 <printf>
      exit(1);
     b44:	4505                	li	a0,1
     ...
     b52:	fd250513          	addi	a0,a0,-46 # 5b20 <malloc+0x5e8>
     b56:	12b040ef          	jal	5480 <printf>
      exit(1);
     b5a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b66:	fe650513          	addi	a0,a0,-26 # 5b48 <malloc+0x610>
     b6a:	117040ef          	jal	5480 <printf>
    exit(1);
     b6e:	4505                	li	a0,1
...
0000000000000b74 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8c:	fd850513          	addi	a0,a0,-40 # 5b60 <malloc+0x628>
  ...
  write(fd, "hello", SZ);
     ...
     ba0:	ff458593          	addi	a1,a1,-12 # 5b90 <malloc+0x658>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	fb050513          	addi	a0,a0,-80 # 5b60 <malloc+0x628>
  ...
  unlink("unlinkread");
     ...
     c3c:	f2850513          	addi	a0,a0,-216 # 5b60 <malloc+0x628>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c58:	f1c50513          	addi	a0,a0,-228 # 5b70 <malloc+0x638>
     c5c:	025040ef          	jal	5480 <printf>
    exit(1);
     c60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6c:	f3050513          	addi	a0,a0,-208 # 5b98 <malloc+0x660>
     c70:	011040ef          	jal	5480 <printf>
    exit(1);
     c74:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c80:	f3c50513          	addi	a0,a0,-196 # 5bb8 <malloc+0x680>
     c84:	7fc040ef          	jal	5480 <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c94:	f5050513          	addi	a0,a0,-176 # 5be0 <malloc+0x6a8>
     c98:	7e8040ef          	jal	5480 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ca8:	f5c50513          	addi	a0,a0,-164 # 5c00 <malloc+0x6c8>
     cac:	7d4040ef          	jal	5480 <printf>
    exit(1);
     cb0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbc:	f6850513          	addi	a0,a0,-152 # 5c20 <malloc+0x6e8>
     cc0:	7c0040ef          	jal	5480 <printf>
    exit(1);
     cc4:	4505                	li	a0,1
...
0000000000000cca <linktest>:
{
  ...
  unlink("lf1");
     ...
     cdc:	f6850513          	addi	a0,a0,-152 # 5c40 <malloc+0x708>
     ce0:	35a040ef          	jal	503a <unlink>
  unlink("lf2");
     ce4:	00005517          	auipc	a0,0x5
     ce8:	f6450513          	addi	a0,a0,-156 # 5c48 <malloc+0x710>
     cec:	34e040ef          	jal	503a <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf0:	20200593          	li	a1,514
     cf4:	00005517          	auipc	a0,0x5
     cf8:	f4c50513          	addi	a0,a0,-180 # 5c40 <malloc+0x708>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0c:	e8858593          	addi	a1,a1,-376 # 5b90 <malloc+0x658>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de4:	e7050513          	addi	a0,a0,-400 # 5c50 <malloc+0x718>
     de8:	698040ef          	jal	5480 <printf>
    exit(1);
     dec:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     df8:	e7450513          	addi	a0,a0,-396 # 5c68 <malloc+0x730>
     dfc:	684040ef          	jal	5480 <printf>
    exit(1);
     e00:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0c:	e7850513          	addi	a0,a0,-392 # 5c80 <malloc+0x748>
     e10:	670040ef          	jal	5480 <printf>
    exit(1);
     e14:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e20:	e8450513          	addi	a0,a0,-380 # 5ca0 <malloc+0x768>
     e24:	65c040ef          	jal	5480 <printf>
    exit(1);
     e28:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e34:	ea050513          	addi	a0,a0,-352 # 5cd0 <malloc+0x798>
     e38:	648040ef          	jal	5480 <printf>
    exit(1);
     e3c:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e48:	ea450513          	addi	a0,a0,-348 # 5ce8 <malloc+0x7b0>
     e4c:	634040ef          	jal	5480 <printf>
    exit(1);
     e50:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5c:	ea850513          	addi	a0,a0,-344 # 5d00 <malloc+0x7c8>
     e60:	620040ef          	jal	5480 <printf>
    exit(1);
     e64:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e70:	ebc50513          	addi	a0,a0,-324 # 5d28 <malloc+0x7f0>
     e74:	60c040ef          	jal	5480 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e84:	ed850513          	addi	a0,a0,-296 # 5d58 <malloc+0x820>
     e88:	5f8040ef          	jal	5480 <printf>
    exit(1);
     e8c:	4505                	li	a0,1
...
0000000000000e92 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eae:	ece98993          	addi	s3,s3,-306 # 5d78 <malloc+0x840>
     eb2:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb4:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee6:	ea650513          	addi	a0,a0,-346 # 5d88 <malloc+0x850>
     eea:	596040ef          	jal	5480 <printf>
      exit(1);
     eee:	4505                	li	a0,1
...
0000000000000ef4 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f10:	e9c50513          	addi	a0,a0,-356 # 5da8 <malloc+0x870>
     f14:	126040ef          	jal	503a <unlink>
  fd = open("bd", O_CREATE);
     f18:	20000593          	li	a1,512
     f1c:	00005517          	auipc	a0,0x5
     f20:	e8c50513          	addi	a0,a0,-372 # 5da8 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f3e:	e6e98993          	addi	s3,s3,-402 # 5da8 <malloc+0x870>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8a:	e2250513          	addi	a0,a0,-478 # 5da8 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff6:	dbe50513          	addi	a0,a0,-578 # 5db0 <malloc+0x878>
     ffa:	486040ef          	jal	5480 <printf>
    exit(1);
     ffe:	4505                	li	a0,1
    ...
    1010:	dc450513          	addi	a0,a0,-572 # 5dd0 <malloc+0x898>
    1014:	46c040ef          	jal	5480 <printf>
      exit(1);
    1018:	4505                	li	a0,1
    ...
    1024:	dd850513          	addi	a0,a0,-552 # 5df8 <malloc+0x8c0>
    1028:	458040ef          	jal	5480 <printf>
      exit(1);
    102c:	4505                	li	a0,1
...
000000000000105e <badarg>:
{
    ...
    1082:	5ea98993          	addi	s3,s3,1514 # 5668 <malloc+0x130>
    argv[0] = (char*)0xffffffff;
...
00000000000010a0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    10f6:	e5678793          	addi	a5,a5,-426 # 6f48 <malloc+0x1a10>
  ...
  if(pid == 0){
    ...
    114a:	a6a78793          	addi	a5,a5,-1430 # 7bb0 <malloc+0x2678>
    ...
    116e:	4fe50513          	addi	a0,a0,1278 # 5668 <malloc+0x130>
    ...
    1182:	d2250513          	addi	a0,a0,-734 # 5ea0 <malloc+0x968>
    1186:	2fa040ef          	jal	5480 <printf>
      exit(1);
    118a:	4505                	li	a0,1
    ...
    119a:	c8250513          	addi	a0,a0,-894 # 5e18 <malloc+0x8e0>
    119e:	2e2040ef          	jal	5480 <printf>
    exit(1);
    11a2:	4505                	li	a0,1
    ...
    11b2:	c8a50513          	addi	a0,a0,-886 # 5e38 <malloc+0x900>
    11b6:	2ca040ef          	jal	5480 <printf>
    exit(1);
    11ba:	4505                	li	a0,1
    ...
    11cc:	c9050513          	addi	a0,a0,-880 # 5e58 <malloc+0x920>
    11d0:	2b0040ef          	jal	5480 <printf>
    exit(1);
    11d4:	4505                	li	a0,1
    ...
    11e4:	ca050513          	addi	a0,a0,-864 # 5e80 <malloc+0x948>
    11e8:	298040ef          	jal	5480 <printf>
    exit(1);
    11ec:	4505                	li	a0,1
    11ee:	5fd030ef          	jal	4fea <exit>
    printf("fork failed\n");
    11f2:	00006517          	auipc	a0,0x6
    11f6:	2ae50513          	addi	a0,a0,686 # 74a0 <malloc+0x1f68>
    11fa:	286040ef          	jal	5480 <printf>
    exit(1);
    11fe:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1230:	c9c50513          	addi	a0,a0,-868 # 5ec8 <malloc+0x990>
    1234:	24c040ef          	jal	5480 <printf>
    exit(1);
    1238:	4505                	li	a0,1
...
000000000000123e <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1252:	47250513          	addi	a0,a0,1138 # 56c0 <malloc+0x188>
  ...
  if(pid == 0){
    ...
    1282:	44298993          	addi	s3,s3,1090 # 56c0 <malloc+0x188>
      int n = write(fd, "1234567890", 10);
    1286:	4a29                	li	s4,10
    1288:	00005b17          	auipc	s6,0x5
    128c:	ca0b0b13          	addi	s6,s6,-864 # 5f28 <malloc+0x9f0>
    ...
    12f2:	c0a50513          	addi	a0,a0,-1014 # 5ef8 <malloc+0x9c0>
    12f6:	18a040ef          	jal	5480 <printf>
    exit(1);
    12fa:	4505                	li	a0,1
    ...
    1306:	c0e50513          	addi	a0,a0,-1010 # 5f10 <malloc+0x9d8>
    130a:	176040ef          	jal	5480 <printf>
        exit(1);
    130e:	4505                	li	a0,1
    ...
    131c:	c2050513          	addi	a0,a0,-992 # 5f38 <malloc+0xa00>
    1320:	160040ef          	jal	5480 <printf>
        exit(1);
    1324:	4505                	li	a0,1
    ...
    1342:	382a0a13          	addi	s4,s4,898 # 56c0 <malloc+0x188>
    int n = write(fd, "xxx", 3);
    1346:	498d                	li	s3,3
    1348:	00005b17          	auipc	s6,0x5
    134c:	c10b0b13          	addi	s6,s6,-1008 # 5f58 <malloc+0xa20>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1350:	85d6                	mv	a1,s5
    1352:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1386:	33e50513          	addi	a0,a0,830 # 56c0 <malloc+0x188>
  ...
  exit(xstatus);
    ...
    13a0:	b7450513          	addi	a0,a0,-1164 # 5f10 <malloc+0x9d8>
    13a4:	0dc040ef          	jal	5480 <printf>
      exit(1);
    13a8:	4505                	li	a0,1
    ...
    13ba:	baa50513          	addi	a0,a0,-1110 # 5f60 <malloc+0xa28>
    13be:	0c2040ef          	jal	5480 <printf>
      exit(1);
    13c2:	4505                	li	a0,1
...
00000000000013c8 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13d8:	29478793          	addi	a5,a5,660 # 5668 <malloc+0x130>
    13dc:	fcf43023          	sd	a5,-64(s0)
    13e0:	00005797          	auipc	a5,0x5
    13e4:	ba078793          	addi	a5,a5,-1120 # 5f80 <malloc+0xa48>
    13e8:	fcf43423          	sd	a5,-56(s0)
    13ec:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f0:	00005517          	auipc	a0,0x5
    13f4:	b9850513          	addi	a0,a0,-1128 # 5f88 <malloc+0xa50>
  ...
  if(pid == 0) {
    ...
    1418:	b7450513          	addi	a0,a0,-1164 # 5f88 <malloc+0xa50>
    ...
    1430:	b7c50513          	addi	a0,a0,-1156 # 5fa8 <malloc+0xa70>
    1434:	04c040ef          	jal	5480 <printf>
      exit(1);
    1438:	4505                	li	a0,1
    ...
    1446:	ab650513          	addi	a0,a0,-1354 # 5ef8 <malloc+0x9c0>
    144a:	036040ef          	jal	5480 <printf>
     exit(1);
    144e:	4505                	li	a0,1
    ...
    145a:	b3a50513          	addi	a0,a0,-1222 # 5f90 <malloc+0xa58>
    145e:	022040ef          	jal	5480 <printf>
      exit(1);
    1462:	4505                	li	a0,1
    ...
    1470:	1fc50513          	addi	a0,a0,508 # 5668 <malloc+0x130>
  ...
  if(xstatus != 0)
    ...
    1498:	b2450513          	addi	a0,a0,-1244 # 5fb8 <malloc+0xa80>
    149c:	7e5030ef          	jal	5480 <printf>
      exit(1);
    14a0:	4505                	li	a0,1
    ...
    14ac:	b2850513          	addi	a0,a0,-1240 # 5fd0 <malloc+0xa98>
    14b0:	7d1030ef          	jal	5480 <printf>
    14b4:	bfd1                	j	1488 <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b6:	4581                	li	a1,0
    14b8:	00005517          	auipc	a0,0x5
    14bc:	ad050513          	addi	a0,a0,-1328 # 5f88 <malloc+0xa50>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14de:	55e50513          	addi	a0,a0,1374 # 5a38 <malloc+0x500>
    14e2:	79f030ef          	jal	5480 <printf>
    exit(1);
    14e6:	4505                	li	a0,1
    ...
    14f2:	a2250513          	addi	a0,a0,-1502 # 5f10 <malloc+0x9d8>
    14f6:	78b030ef          	jal	5480 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    14fc:	2ef030ef          	jal	4fea <exit>
  unlink("echo-ok");
    1500:	00005517          	auipc	a0,0x5
    1504:	a8850513          	addi	a0,a0,-1400 # 5f88 <malloc+0xa50>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152a:	ac250513          	addi	a0,a0,-1342 # 5fe8 <malloc+0xab0>
    152e:	753030ef          	jal	5480 <printf>
    exit(1);
    1532:	4505                	li	a0,1
...
000000000000153e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	a2e50513          	addi	a0,a0,-1490 # 6000 <malloc+0xac8>
    15da:	6a7030ef          	jal	5480 <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0x65>
{
    ...
    1650:	9cc50513          	addi	a0,a0,-1588 # 6018 <malloc+0xae0>
    1654:	62d030ef          	jal	5480 <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	9d050513          	addi	a0,a0,-1584 # 6030 <malloc+0xaf8>
    1668:	619030ef          	jal	5480 <printf>
          return;
    ...
    1696:	9b650513          	addi	a0,a0,-1610 # 6048 <malloc+0xb10>
    169a:	5e7030ef          	jal	5480 <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	99a50513          	addi	a0,a0,-1638 # 6068 <malloc+0xb30>
    16d6:	5ab030ef          	jal	5480 <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	7c250513          	addi	a0,a0,1986 # 5ef8 <malloc+0x9c0>
    173e:	543030ef          	jal	5480 <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	93650513          	addi	a0,a0,-1738 # 6080 <malloc+0xb48>
    1752:	52f030ef          	jal	5480 <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	93a50513          	addi	a0,a0,-1734 # 6098 <malloc+0xb60>
    1766:	51b030ef          	jal	5480 <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	73e50513          	addi	a0,a0,1854 # 5ef8 <malloc+0x9c0>
    17c2:	4bf030ef          	jal	5480 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	72650513          	addi	a0,a0,1830 # 5ef8 <malloc+0x9c0>
    17da:	4a7030ef          	jal	5480 <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	88850513          	addi	a0,a0,-1912 # 60b8 <malloc+0xb80>
    1838:	449030ef          	jal	5480 <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	7ac030ef          	jal	4fea <exit>
{
    ...
    1870:	85c50513          	addi	a0,a0,-1956 # 60c8 <malloc+0xb90>
    1874:	40d030ef          	jal	5480 <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	bfa50513          	addi	a0,a0,-1030 # 74a0 <malloc+0x1f68>
    18ae:	3d3030ef          	jal	5480 <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1936:	5c650513          	addi	a0,a0,1478 # 5ef8 <malloc+0x9c0>
    193a:	347030ef          	jal	5480 <printf>
      exit(1);
    193e:	4505                	li	a0,1
    ...
    1962:	63250513          	addi	a0,a0,1586 # 5f90 <malloc+0xa58>
    1966:	31b030ef          	jal	5480 <printf>
          exit(1);
    196a:	4505                	li	a0,1
    ...
    19c2:	72a50513          	addi	a0,a0,1834 # 60e8 <malloc+0xbb0>
    19c6:	2bb030ef          	jal	5480 <printf>
            exit(1);
    19ca:	4505                	li	a0,1
    ...
    1a0c:	6f850513          	addi	a0,a0,1784 # 6100 <malloc+0xbc8>
    1a10:	271030ef          	jal	5480 <printf>
        exit(1);
    1a14:	4505                	li	a0,1
    ...
    1a28:	70450513          	addi	a0,a0,1796 # 6128 <malloc+0xbf0>
    1a2c:	255030ef          	jal	5480 <printf>
        exit(1);
    1a30:	4505                	li	a0,1
...
0000000000001ab2 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ad4:	c0850513          	addi	a0,a0,-1016 # 56d8 <malloc+0x1a0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b14:	bc8b0b13          	addi	s6,s6,-1080 # 56d8 <malloc+0x1a0>
      link("cat", "x");
    1b18:	00004c97          	auipc	s9,0x4
    1b1c:	638c8c93          	addi	s9,s9,1592 # 6150 <malloc+0xc18>
    ...
    1b2c:	3d050513          	addi	a0,a0,976 # 5ef8 <malloc+0x9c0>
    1b30:	151030ef          	jal	5480 <printf>
    exit(1);
    1b34:	4505                	li	a0,1
...
0000000000001bac <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bd8:	5cc50513          	addi	a0,a0,1484 # 61a0 <malloc+0xc68>
    1bdc:	0a5030ef          	jal	5480 <printf>
    exit(1);
    1be0:	4505                	li	a0,1
    ...
    1bf0:	56c50513          	addi	a0,a0,1388 # 6158 <malloc+0xc20>
    1bf4:	08d030ef          	jal	5480 <printf>
    exit(1);
    1bf8:	4505                	li	a0,1
    ...
    1c04:	57050513          	addi	a0,a0,1392 # 6170 <malloc+0xc38>
    1c08:	079030ef          	jal	5480 <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c18:	57450513          	addi	a0,a0,1396 # 6188 <malloc+0xc50>
    1c1c:	065030ef          	jal	5480 <printf>
    exit(1);
    1c20:	4505                	li	a0,1
...
0000000000001c54 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cbc:	24050513          	addi	a0,a0,576 # 5ef8 <malloc+0x9c0>
    1cc0:	7c0030ef          	jal	5480 <printf>
      exit(1);
    1cc4:	4505                	li	a0,1
    ...
    1cd6:	4f650513          	addi	a0,a0,1270 # 61c8 <malloc+0xc90>
    1cda:	7a6030ef          	jal	5480 <printf>
      exit(1);
    1cde:	4505                	li	a0,1
...
0000000000001cea <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d4a:	1b250513          	addi	a0,a0,434 # 5ef8 <malloc+0x9c0>
    1d4e:	732030ef          	jal	5480 <printf>
      exit(1);
    1d52:	4505                	li	a0,1
    ...
    1d6e:	47e50513          	addi	a0,a0,1150 # 61e8 <malloc+0xcb0>
    1d72:	70e030ef          	jal	5480 <printf>
      exit(1);
    1d76:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1dbe:	44650513          	addi	a0,a0,1094 # 6200 <malloc+0xcc8>
    1dc2:	6be030ef          	jal	5480 <printf>
    exit(1);
    1dc6:	4505                	li	a0,1
    ...
    1dd2:	12a50513          	addi	a0,a0,298 # 5ef8 <malloc+0x9c0>
    1dd6:	6aa030ef          	jal	5480 <printf>
    exit(1);
    1dda:	4505                	li	a0,1
...
0000000000001de6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1dfc:	db878793          	addi	a5,a5,-584 # 7bb0 <malloc+0x2678>
  ...
  exit(0);
    ...
    1e66:	3c650513          	addi	a0,a0,966 # 6228 <malloc+0xcf0>
    1e6a:	616030ef          	jal	5480 <printf>
      exit(0);
    1e6e:	4501                	li	a0,0
    ...
    1e7a:	08250513          	addi	a0,a0,130 # 5ef8 <malloc+0x9c0>
    1e7e:	602030ef          	jal	5480 <printf>
      exit(1);
    1e82:	4505                	li	a0,1
...
0000000000001e8e <manywrites>:
{
  ...
  exit(0);
    ...
    1ef2:	5b250513          	addi	a0,a0,1458 # 74a0 <malloc+0x1f68>
    1ef6:	58a030ef          	jal	5480 <printf>
      exit(1);
    1efa:	4505                	li	a0,1
    ...
    1f92:	2ba50513          	addi	a0,a0,698 # 6248 <malloc+0xd10>
    1f96:	4ea030ef          	jal	5480 <printf>
            exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	79250513          	addi	a0,a0,1938 # 5738 <malloc+0x200>
    1fae:	4d2030ef          	jal	5480 <printf>
            exit(1);
    1fb2:	4505                	li	a0,1
...
0000000000001fc8 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    202a:	f2278793          	addi	a5,a5,-222 # 6f48 <malloc+0x1a10>
  ...
  if(ret != -1){
    ...
    2064:	20050513          	addi	a0,a0,512 # 6260 <malloc+0xd28>
    2068:	418030ef          	jal	5480 <printf>
    exit(1);
    206c:	4505                	li	a0,1
    ...
    207a:	da250513          	addi	a0,a0,-606 # 5e18 <malloc+0x8e0>
    207e:	402030ef          	jal	5480 <printf>
    exit(1);
    2082:	4505                	li	a0,1
    ...
    2090:	dac50513          	addi	a0,a0,-596 # 5e38 <malloc+0x900>
    2094:	3ec030ef          	jal	5480 <printf>
    exit(1);
    2098:	4505                	li	a0,1
    ...
    20a8:	db450513          	addi	a0,a0,-588 # 5e58 <malloc+0x920>
    20ac:	3d4030ef          	jal	5480 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    ...
    20be:	dc650513          	addi	a0,a0,-570 # 5e80 <malloc+0x948>
    20c2:	3be030ef          	jal	5480 <printf>
    exit(1);
    20c6:	4505                	li	a0,1
...
00000000000020cc <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    20fa:	1aa50513          	addi	a0,a0,426 # 62a0 <malloc+0xd68>
  ...
  if(n >= 0){
    ...
    2122:	1a250513          	addi	a0,a0,418 # 62c0 <malloc+0xd88>
    2126:	35a030ef          	jal	5480 <printf>
    exit(1);
    212a:	4505                	li	a0,1
    ...
    2138:	13450513          	addi	a0,a0,308 # 6268 <malloc+0xd30>
    213c:	344030ef          	jal	5480 <printf>
    exit(1);
    2140:	4505                	li	a0,1
    ...
    214c:	13850513          	addi	a0,a0,312 # 6280 <malloc+0xd48>
    2150:	330030ef          	jal	5480 <printf>
    exit(1);
    2154:	4505                	li	a0,1
    2156:	695020ef          	jal	4fea <exit>
    printf("open(rwsbrk) failed\n");
    215a:	00004517          	auipc	a0,0x4
    215e:	14e50513          	addi	a0,a0,334 # 62a8 <malloc+0xd70>
    2162:	31e030ef          	jal	5480 <printf>
    exit(1);
    2166:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2176:	12e50513          	addi	a0,a0,302 # 62a0 <malloc+0xd68>
    217a:	6c1020ef          	jal	503a <unlink>
  fd = open("README", O_RDONLY);
    217e:	4581                	li	a1,0
    2180:	00003517          	auipc	a0,0x3
    2184:	6c050513          	addi	a0,a0,1728 # 5840 <malloc+0x308>
  ...
  if(n >= 0){
    ...
    21a6:	14e50513          	addi	a0,a0,334 # 62f0 <malloc+0xdb8>
    21aa:	2d6030ef          	jal	5480 <printf>
    exit(1);
    21ae:	4505                	li	a0,1
    21b0:	63b020ef          	jal	4fea <exit>
    printf("open(README) failed\n");
    21b4:	00003517          	auipc	a0,0x3
    21b8:	69450513          	addi	a0,a0,1684 # 5848 <malloc+0x310>
    21bc:	2c4030ef          	jal	5480 <printf>
    exit(1);
    21c0:	4505                	li	a0,1
...
00000000000021d2 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2226:	0f650513          	addi	a0,a0,246 # 6318 <malloc+0xde0>
    222a:	256030ef          	jal	5480 <printf>
    exit(1);
    222e:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    227e:	0be50513          	addi	a0,a0,190 # 6338 <malloc+0xe00>
    2282:	1fe030ef          	jal	5480 <printf>
    exit(1);
    2286:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    22c8:	0d450513          	addi	a0,a0,212 # 6398 <malloc+0xe60>
    22cc:	1b4030ef          	jal	5480 <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e2:	07a50513          	addi	a0,a0,122 # 6358 <malloc+0xe20>
    22e6:	19a030ef          	jal	5480 <printf>
      exit(1);
    22ea:	4505                	li	a0,1
    ...
    22f6:	08650513          	addi	a0,a0,134 # 6378 <malloc+0xe40>
    22fa:	186030ef          	jal	5480 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
000000000000231e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    23e2:	fda50513          	addi	a0,a0,-38 # 63b8 <malloc+0xe80>
    23e6:	09a030ef          	jal	5480 <printf>
    exit(1);
    23ea:	4505                	li	a0,1
    ...
    23f6:	00e50513          	addi	a0,a0,14 # 6400 <malloc+0xec8>
    23fa:	086030ef          	jal	5480 <printf>
    exit(1);
    23fe:	4505                	li	a0,1
    ...
    240e:	01650513          	addi	a0,a0,22 # 6420 <malloc+0xee8>
    2412:	06e030ef          	jal	5480 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    2426:	03e50513          	addi	a0,a0,62 # 6460 <malloc+0xf28>
    242a:	056030ef          	jal	5480 <printf>
    exit(1);
    242e:	4505                	li	a0,1
    ...
    243a:	05a50513          	addi	a0,a0,90 # 6490 <malloc+0xf58>
    243e:	042030ef          	jal	5480 <printf>
    exit(1);
    2442:	4505                	li	a0,1
    ...
    2452:	07a50513          	addi	a0,a0,122 # 64c8 <malloc+0xf90>
    2456:	02a030ef          	jal	5480 <printf>
    exit(1);
    245a:	4505                	li	a0,1
...
0000000000002460 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2480:	07450513          	addi	a0,a0,116 # 64f0 <malloc+0xfb8>
    2484:	3a7020ef          	jal	502a <open>
    2488:	84aa                	mv	s1,a0
  unlink("sbrk");
    248a:	00004517          	auipc	a0,0x4
    248e:	06650513          	addi	a0,a0,102 # 64f0 <malloc+0xfb8>
  ...
  if(pipe((int *) a) != 0){
    ...
    24ce:	02e50513          	addi	a0,a0,46 # 64f8 <malloc+0xfc0>
    24d2:	7af020ef          	jal	5480 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
    ...
    24e2:	03250513          	addi	a0,a0,50 # 6510 <malloc+0xfd8>
    24e6:	79b020ef          	jal	5480 <printf>
    exit(1);
    24ea:	4505                	li	a0,1
    ...
    24f6:	b0e50513          	addi	a0,a0,-1266 # 6000 <malloc+0xac8>
    24fa:	787020ef          	jal	5480 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002504 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2518:	01450513          	addi	a0,a0,20 # 6528 <malloc+0xff0>
  ...
  close(fd);
    ...
    2550:	9c450513          	addi	a0,a0,-1596 # 5f10 <malloc+0x9d8>
    2554:	72d020ef          	jal	5480 <printf>
    exit(1);
    2558:	4505                	li	a0,1
...
000000000000255e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2586:	f1e50513          	addi	a0,a0,-226 # 74a0 <malloc+0x1f68>
    258a:	6f7020ef          	jal	5480 <printf>
    exit(1);
    258e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25c0:	ee450513          	addi	a0,a0,-284 # 74a0 <malloc+0x1f68>
    25c4:	6bd020ef          	jal	5480 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2600:	ea450513          	addi	a0,a0,-348 # 74a0 <malloc+0x1f68>
    2604:	67d020ef          	jal	5480 <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
00000000000026ea <execout>:
{
  ...
  exit(0);
    ...
    2726:	d7e50513          	addi	a0,a0,-642 # 74a0 <malloc+0x1f68>
    272a:	557020ef          	jal	5480 <printf>
      exit(1);
    272e:	4505                	li	a0,1
...
000000000000279a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27ca:	dea50513          	addi	a0,a0,-534 # 65b0 <malloc+0x1078>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27e0:	e4c50513          	addi	a0,a0,-436 # 6628 <malloc+0x10f0>
  ...
  unlink("12345678901234");
    ...
    2864:	cd050513          	addi	a0,a0,-816 # 6530 <malloc+0xff8>
    2868:	419020ef          	jal	5480 <printf>
    exit(1);
    286c:	4505                	li	a0,1
    ...
    2878:	d0450513          	addi	a0,a0,-764 # 6578 <malloc+0x1040>
    287c:	405020ef          	jal	5480 <printf>
    exit(1);
    2880:	4505                	li	a0,1
    ...
    288c:	d5850513          	addi	a0,a0,-680 # 65e0 <malloc+0x10a8>
    2890:	3f1020ef          	jal	5480 <printf>
    exit(1);
    2894:	4505                	li	a0,1
    ...
    28a0:	dbc50513          	addi	a0,a0,-580 # 6658 <malloc+0x1120>
    28a4:	3dd020ef          	jal	5480 <printf>
    exit(1);
    28a8:	4505                	li	a0,1
    ...
    28b4:	e0850513          	addi	a0,a0,-504 # 66b8 <malloc+0x1180>
    28b8:	3c9020ef          	jal	5480 <printf>
    exit(1);
    28bc:	4505                	li	a0,1
    ...
    28c8:	e4c50513          	addi	a0,a0,-436 # 6710 <malloc+0x11d8>
    28cc:	3b5020ef          	jal	5480 <printf>
    exit(1);
    28d0:	4505                	li	a0,1
...
00000000000028d6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    291a:	e3250513          	addi	a0,a0,-462 # 6748 <malloc+0x1210>
    ...
    2950:	e0c50513          	addi	a0,a0,-500 # 6758 <malloc+0x1220>
    2954:	32d020ef          	jal	5480 <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2afe:	c7e50513          	addi	a0,a0,-898 # 6778 <malloc+0x1240>
    2b02:	17f020ef          	jal	5480 <printf>
...
0000000000002b08 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2b64:	c5050513          	addi	a0,a0,-944 # 67b0 <malloc+0x1278>
    2b68:	119020ef          	jal	5480 <printf>
    exit(1);
    2b6c:	4505                	li	a0,1
    ...
    2b78:	c5450513          	addi	a0,a0,-940 # 67c8 <malloc+0x1290>
    2b7c:	105020ef          	jal	5480 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	c7050513          	addi	a0,a0,-912 # 67f8 <malloc+0x12c0>
    2b90:	0f1020ef          	jal	5480 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	c8450513          	addi	a0,a0,-892 # 6820 <malloc+0x12e8>
    2ba4:	0dd020ef          	jal	5480 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
...
0000000000002bae <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c00:	2fc50513          	addi	a0,a0,764 # 5ef8 <malloc+0x9c0>
    2c04:	07d020ef          	jal	5480 <printf>
    exit(1);
    2c08:	4505                	li	a0,1
    ...
    2c14:	ba050513          	addi	a0,a0,-1120 # 67b0 <malloc+0x1278>
    2c18:	069020ef          	jal	5480 <printf>
      exit(1);
    2c1c:	4505                	li	a0,1
    ...
    2c28:	c1450513          	addi	a0,a0,-1004 # 6838 <malloc+0x1300>
    2c2c:	055020ef          	jal	5480 <printf>
      exit(1);
    2c30:	4505                	li	a0,1
    ...
    2c3c:	bc050513          	addi	a0,a0,-1088 # 67f8 <malloc+0x12c0>
    2c40:	041020ef          	jal	5480 <printf>
      exit(1);
    2c44:	4505                	li	a0,1
...
0000000000002c5a <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2cb6:	afe50513          	addi	a0,a0,-1282 # 67b0 <malloc+0x1278>
    2cba:	7c6020ef          	jal	5480 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
    ...
    2cca:	b9250513          	addi	a0,a0,-1134 # 6858 <malloc+0x1320>
    2cce:	7b2020ef          	jal	5480 <printf>
    exit(1);
    2cd2:	4505                	li	a0,1
    ...
    2cde:	b9e50513          	addi	a0,a0,-1122 # 6878 <malloc+0x1340>
    2ce2:	79e020ef          	jal	5480 <printf>
    exit(1);
    2ce6:	4505                	li	a0,1
    ...
    2cf2:	ba250513          	addi	a0,a0,-1118 # 6890 <malloc+0x1358>
    2cf6:	78a020ef          	jal	5480 <printf>
    exit(1);
    2cfa:	4505                	li	a0,1
...
0000000000002d00 <subdir>:
{
  ...
  unlink("ff");
    ...
    2d12:	cca50513          	addi	a0,a0,-822 # 69d8 <malloc+0x14a0>
    2d16:	324020ef          	jal	503a <unlink>
  if(mkdir("dd") != 0){
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	b8e50513          	addi	a0,a0,-1138 # 68a8 <malloc+0x1370>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d32:	b9a50513          	addi	a0,a0,-1126 # 68c8 <malloc+0x1390>
  ...
  write(fd, "ff", 2);
    ...
    2d46:	c9658593          	addi	a1,a1,-874 # 69d8 <malloc+0x14a0>
  ...
  if(unlink("dd") >= 0){
    ...
    2d58:	b5450513          	addi	a0,a0,-1196 # 68a8 <malloc+0x1370>
    2d5c:	2de020ef          	jal	503a <unlink>
    2d60:	2c055963          	bgez	a0,3032 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2d64:	00004517          	auipc	a0,0x4
    2d68:	bbc50513          	addi	a0,a0,-1092 # 6920 <malloc+0x13e8>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d7c:	bd050513          	addi	a0,a0,-1072 # 6948 <malloc+0x1410>
  ...
  write(fd, "FF", 2);
    ...
    2d90:	bec58593          	addi	a1,a1,-1044 # 6978 <malloc+0x1440>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da4:	be050513          	addi	a0,a0,-1056 # 6980 <malloc+0x1448>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e8a:	ac250513          	addi	a0,a0,-1342 # 6948 <malloc+0x1410>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2e9e:	cc650513          	addi	a0,a0,-826 # 6b60 <malloc+0x1628>
  ...
  if(unlink("dd") < 0){
    ...
    3010:	8a450513          	addi	a0,a0,-1884 # 68b0 <malloc+0x1378>
    3014:	46c020ef          	jal	5480 <printf>
    exit(1);
    3018:	4505                	li	a0,1
    ...
    3024:	8b050513          	addi	a0,a0,-1872 # 68d0 <malloc+0x1398>
    3028:	458020ef          	jal	5480 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    3038:	8bc50513          	addi	a0,a0,-1860 # 68f0 <malloc+0x13b8>
    303c:	444020ef          	jal	5480 <printf>
    exit(1);
    3040:	4505                	li	a0,1
    ...
    304c:	8e050513          	addi	a0,a0,-1824 # 6928 <malloc+0x13f0>
    3050:	430020ef          	jal	5480 <printf>
    exit(1);
    3054:	4505                	li	a0,1
    ...
    3060:	8fc50513          	addi	a0,a0,-1796 # 6958 <malloc+0x1420>
    3064:	41c020ef          	jal	5480 <printf>
    exit(1);
    3068:	4505                	li	a0,1
    ...
    3074:	92050513          	addi	a0,a0,-1760 # 6990 <malloc+0x1458>
    3078:	408020ef          	jal	5480 <printf>
    exit(1);
    307c:	4505                	li	a0,1
    ...
    3088:	92c50513          	addi	a0,a0,-1748 # 69b0 <malloc+0x1478>
    308c:	3f4020ef          	jal	5480 <printf>
    exit(1);
    3090:	4505                	li	a0,1
    ...
    309c:	94850513          	addi	a0,a0,-1720 # 69e0 <malloc+0x14a8>
    30a0:	3e0020ef          	jal	5480 <printf>
    exit(1);
    30a4:	4505                	li	a0,1
    ...
    30b0:	95c50513          	addi	a0,a0,-1700 # 6a08 <malloc+0x14d0>
    30b4:	3cc020ef          	jal	5480 <printf>
    exit(1);
    30b8:	4505                	li	a0,1
    ...
    30c4:	96850513          	addi	a0,a0,-1688 # 6a28 <malloc+0x14f0>
    30c8:	3b8020ef          	jal	5480 <printf>
    exit(1);
    30cc:	4505                	li	a0,1
    ...
    30d8:	97c50513          	addi	a0,a0,-1668 # 6a50 <malloc+0x1518>
    30dc:	3a4020ef          	jal	5480 <printf>
    exit(1);
    30e0:	4505                	li	a0,1
    ...
    30ec:	99050513          	addi	a0,a0,-1648 # 6a78 <malloc+0x1540>
    30f0:	390020ef          	jal	5480 <printf>
    exit(1);
    30f4:	4505                	li	a0,1
    ...
    3100:	9ac50513          	addi	a0,a0,-1620 # 6aa8 <malloc+0x1570>
    3104:	37c020ef          	jal	5480 <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3114:	9c850513          	addi	a0,a0,-1592 # 6ad8 <malloc+0x15a0>
    3118:	368020ef          	jal	5480 <printf>
    exit(1);
    311c:	4505                	li	a0,1
    ...
    3128:	9cc50513          	addi	a0,a0,-1588 # 6af0 <malloc+0x15b8>
    312c:	354020ef          	jal	5480 <printf>
    exit(1);
    3130:	4505                	li	a0,1
    ...
    313c:	9d850513          	addi	a0,a0,-1576 # 6b10 <malloc+0x15d8>
    3140:	340020ef          	jal	5480 <printf>
    exit(1);
    3144:	4505                	li	a0,1
    ...
    3150:	9e450513          	addi	a0,a0,-1564 # 6b30 <malloc+0x15f8>
    3154:	32c020ef          	jal	5480 <printf>
    exit(1);
    3158:	4505                	li	a0,1
    ...
    3164:	a1050513          	addi	a0,a0,-1520 # 6b70 <malloc+0x1638>
    3168:	318020ef          	jal	5480 <printf>
    exit(1);
    316c:	4505                	li	a0,1
    ...
    3178:	a2c50513          	addi	a0,a0,-1492 # 6ba0 <malloc+0x1668>
    317c:	304020ef          	jal	5480 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    318c:	a3850513          	addi	a0,a0,-1480 # 6bc0 <malloc+0x1688>
    3190:	2f0020ef          	jal	5480 <printf>
    exit(1);
    3194:	4505                	li	a0,1
    ...
    31a0:	a4450513          	addi	a0,a0,-1468 # 6be0 <malloc+0x16a8>
    31a4:	2dc020ef          	jal	5480 <printf>
    exit(1);
    31a8:	4505                	li	a0,1
    ...
    31b4:	a5050513          	addi	a0,a0,-1456 # 6c00 <malloc+0x16c8>
    31b8:	2c8020ef          	jal	5480 <printf>
    exit(1);
    31bc:	4505                	li	a0,1
    ...
    31c8:	a6c50513          	addi	a0,a0,-1428 # 6c30 <malloc+0x16f8>
    31cc:	2b4020ef          	jal	5480 <printf>
    exit(1);
    31d0:	4505                	li	a0,1
    ...
    31dc:	a8050513          	addi	a0,a0,-1408 # 6c58 <malloc+0x1720>
    31e0:	2a0020ef          	jal	5480 <printf>
    exit(1);
    31e4:	4505                	li	a0,1
    ...
    31f0:	a9450513          	addi	a0,a0,-1388 # 6c80 <malloc+0x1748>
    31f4:	28c020ef          	jal	5480 <printf>
    exit(1);
    31f8:	4505                	li	a0,1
    ...
    3204:	aa850513          	addi	a0,a0,-1368 # 6ca8 <malloc+0x1770>
    3208:	278020ef          	jal	5480 <printf>
    exit(1);
    320c:	4505                	li	a0,1
    ...
    3218:	ab450513          	addi	a0,a0,-1356 # 6cc8 <malloc+0x1790>
    321c:	264020ef          	jal	5480 <printf>
    exit(1);
    3220:	4505                	li	a0,1
    ...
    322c:	ac050513          	addi	a0,a0,-1344 # 6ce8 <malloc+0x17b0>
    3230:	250020ef          	jal	5480 <printf>
    exit(1);
    3234:	4505                	li	a0,1
    ...
    3240:	ad450513          	addi	a0,a0,-1324 # 6d10 <malloc+0x17d8>
    3244:	23c020ef          	jal	5480 <printf>
    exit(1);
    3248:	4505                	li	a0,1
    ...
    3254:	ae050513          	addi	a0,a0,-1312 # 6d30 <malloc+0x17f8>
    3258:	228020ef          	jal	5480 <printf>
    exit(1);
    325c:	4505                	li	a0,1
    ...
    3268:	aec50513          	addi	a0,a0,-1300 # 6d50 <malloc+0x1818>
    326c:	214020ef          	jal	5480 <printf>
    exit(1);
    3270:	4505                	li	a0,1
    ...
    327c:	b0050513          	addi	a0,a0,-1280 # 6d78 <malloc+0x1840>
    3280:	200020ef          	jal	5480 <printf>
    exit(1);
    3284:	4505                	li	a0,1
    ...
    3290:	77c50513          	addi	a0,a0,1916 # 6a08 <malloc+0x14d0>
    3294:	1ec020ef          	jal	5480 <printf>
    exit(1);
    3298:	4505                	li	a0,1
    ...
    32a4:	af850513          	addi	a0,a0,-1288 # 6d98 <malloc+0x1860>
    32a8:	1d8020ef          	jal	5480 <printf>
    exit(1);
    32ac:	4505                	li	a0,1
    ...
    32b8:	b0450513          	addi	a0,a0,-1276 # 6db8 <malloc+0x1880>
    32bc:	1c4020ef          	jal	5480 <printf>
    exit(1);
    32c0:	4505                	li	a0,1
    ...
    32cc:	b2050513          	addi	a0,a0,-1248 # 6de8 <malloc+0x18b0>
    32d0:	1b0020ef          	jal	5480 <printf>
    exit(1);
    32d4:	4505                	li	a0,1
    ...
    32e0:	b2c50513          	addi	a0,a0,-1236 # 6e08 <malloc+0x18d0>
    32e4:	19c020ef          	jal	5480 <printf>
    exit(1);
    32e8:	4505                	li	a0,1
...
00000000000032ee <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    337a:	ab250513          	addi	a0,a0,-1358 # 6e28 <malloc+0x18f0>
    337e:	102020ef          	jal	5480 <printf>
    exit(1);
    3382:	4505                	li	a0,1
    ...
    338e:	ab650513          	addi	a0,a0,-1354 # 6e40 <malloc+0x1908>
    3392:	0ee020ef          	jal	5480 <printf>
    exit(1);
    3396:	4505                	li	a0,1
    ...
    33a2:	aba50513          	addi	a0,a0,-1350 # 6e58 <malloc+0x1920>
    33a6:	0da020ef          	jal	5480 <printf>
    exit(1);
    33aa:	4505                	li	a0,1
    ...
    33b6:	abe50513          	addi	a0,a0,-1346 # 6e70 <malloc+0x1938>
    33ba:	0c6020ef          	jal	5480 <printf>
    exit(1);
    33be:	4505                	li	a0,1
    ...
    33ca:	45a50513          	addi	a0,a0,1114 # 6820 <malloc+0x12e8>
    33ce:	0b2020ef          	jal	5480 <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33de:	ab650513          	addi	a0,a0,-1354 # 6e90 <malloc+0x1958>
    33e2:	09e020ef          	jal	5480 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	aca50513          	addi	a0,a0,-1334 # 6eb8 <malloc+0x1980>
    33f6:	08a020ef          	jal	5480 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	ad650513          	addi	a0,a0,-1322 # 6ed8 <malloc+0x19a0>
    340a:	076020ef          	jal	5480 <printf>
    exit(1);
    340e:	4505                	li	a0,1
...
0000000000003414 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    342a:	ad250513          	addi	a0,a0,-1326 # 6ef8 <malloc+0x19c0>
  ...
  if(chdir("dirfile") == 0){
    ...
    343e:	abe50513          	addi	a0,a0,-1346 # 6ef8 <malloc+0x19c0>
    3442:	419010ef          	jal	505a <chdir>
    3446:	c569                	beqz	a0,3510 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3448:	4581                	li	a1,0
    344a:	00004517          	auipc	a0,0x4
    344e:	af650513          	addi	a0,a0,-1290 # 6f40 <malloc+0x1a08>
  ...
  fd = open(".", 0);
    ...
    34ce:	88650513          	addi	a0,a0,-1914 # 5d50 <malloc+0x818>
    34d2:	359010ef          	jal	502a <open>
    34d6:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    34d8:	4605                	li	a2,1
    34da:	00002597          	auipc	a1,0x2
    34de:	1fe58593          	addi	a1,a1,510 # 56d8 <malloc+0x1a0>
  ...
  close(fd);
    ...
    3502:	a0250513          	addi	a0,a0,-1534 # 6f00 <malloc+0x19c8>
    3506:	77b010ef          	jal	5480 <printf>
    exit(1);
    350a:	4505                	li	a0,1
    ...
    3516:	a0e50513          	addi	a0,a0,-1522 # 6f20 <malloc+0x19e8>
    351a:	767010ef          	jal	5480 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352a:	a2a50513          	addi	a0,a0,-1494 # 6f50 <malloc+0x1a18>
    352e:	753010ef          	jal	5480 <printf>
    exit(1);
    3532:	4505                	li	a0,1
    ...
    353e:	a1650513          	addi	a0,a0,-1514 # 6f50 <malloc+0x1a18>
    3542:	73f010ef          	jal	5480 <printf>
    exit(1);
    3546:	4505                	li	a0,1
    ...
    3552:	a2a50513          	addi	a0,a0,-1494 # 6f78 <malloc+0x1a40>
    3556:	72b010ef          	jal	5480 <printf>
    exit(1);
    355a:	4505                	li	a0,1
    ...
    3566:	a3e50513          	addi	a0,a0,-1474 # 6fa0 <malloc+0x1a68>
    356a:	717010ef          	jal	5480 <printf>
    exit(1);
    356e:	4505                	li	a0,1
    ...
    357a:	a5250513          	addi	a0,a0,-1454 # 6fc8 <malloc+0x1a90>
    357e:	703010ef          	jal	5480 <printf>
    exit(1);
    3582:	4505                	li	a0,1
    ...
    358e:	a6650513          	addi	a0,a0,-1434 # 6ff0 <malloc+0x1ab8>
    3592:	6ef010ef          	jal	5480 <printf>
    exit(1);
    3596:	4505                	li	a0,1
    ...
    35a2:	a7250513          	addi	a0,a0,-1422 # 7010 <malloc+0x1ad8>
    35a6:	6db010ef          	jal	5480 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35b6:	a8650513          	addi	a0,a0,-1402 # 7038 <malloc+0x1b00>
    35ba:	6c7010ef          	jal	5480 <printf>
    exit(1);
    35be:	4505                	li	a0,1
...
00000000000035c4 <iref>:
{
    ...
    35e4:	a70a8a93          	addi	s5,s5,-1424 # 7050 <malloc+0x1b18>
    mkdir("");
    35e8:	00003497          	auipc	s1,0x3
    35ec:	57048493          	addi	s1,s1,1392 # 6b58 <malloc+0x1620>
    link("README", "");
    35f0:	00002b17          	auipc	s6,0x2
    35f4:	250b0b13          	addi	s6,s6,592 # 5840 <malloc+0x308>
    fd = open("", O_CREATE);
    35f8:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    35fc:	00004997          	auipc	s3,0x4
    3600:	94c98993          	addi	s3,s3,-1716 # 6f48 <malloc+0x1a10>
    3604:	a835                	j	3640 <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    3606:	85de                	mv	a1,s7
    3608:	00004517          	auipc	a0,0x4
    360c:	a5050513          	addi	a0,a0,-1456 # 7058 <malloc+0x1b20>
    3610:	671010ef          	jal	5480 <printf>
      exit(1);
    3614:	4505                	li	a0,1
    ...
    3620:	a5450513          	addi	a0,a0,-1452 # 7070 <malloc+0x1b38>
    3624:	65d010ef          	jal	5480 <printf>
      exit(1);
    3628:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3684:	1f098993          	addi	s3,s3,496 # 6870 <malloc+0x1338>
    unlink("irefd");
    3688:	00004917          	auipc	s2,0x4
    368c:	9c890913          	addi	s2,s2,-1592 # 7050 <malloc+0x1b18>
    chdir("..");
    3690:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    36a4:	17850513          	addi	a0,a0,376 # 6818 <malloc+0x12e0>
...
00000000000036c2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    36d2:	9ba50513          	addi	a0,a0,-1606 # 7088 <malloc+0x1b50>
  ...
  if(pid == 0){
    ...
    36ee:	99e50513          	addi	a0,a0,-1634 # 7088 <malloc+0x1b50>
    ...
    3700:	9ac50513          	addi	a0,a0,-1620 # 70a8 <malloc+0x1b70>
    3704:	57d010ef          	jal	5480 <printf>
      exit(1);
    3708:	4505                	li	a0,1
    ...
    3714:	98050513          	addi	a0,a0,-1664 # 7090 <malloc+0x1b58>
    3718:	569010ef          	jal	5480 <printf>
    exit(1);
    371c:	4505                	li	a0,1
    ...
    3728:	7d450513          	addi	a0,a0,2004 # 5ef8 <malloc+0x9c0>
    372c:	555010ef          	jal	5480 <printf>
    exit(1);
    3730:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3746:	94650513          	addi	a0,a0,-1722 # 7088 <malloc+0x1b50>
    374a:	0f1010ef          	jal	503a <unlink>
    374e:	c919                	beqz	a0,3764 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3750:	85a6                	mv	a1,s1
    3752:	00003517          	auipc	a0,0x3
    3756:	99650513          	addi	a0,a0,-1642 # 60e8 <malloc+0xbb0>
    375a:	527010ef          	jal	5480 <printf>
    exit(1);
    375e:	4505                	li	a0,1
...
0000000000003774 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3784:	95050513          	addi	a0,a0,-1712 # 70d0 <malloc+0x1b98>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    37a4:	93050513          	addi	a0,a0,-1744 # 70d0 <malloc+0x1b98>
  ...
  pause(10); // one second
    ...
    37cc:	8f050513          	addi	a0,a0,-1808 # 60b8 <malloc+0xb80>
    37d0:	4b1010ef          	jal	5480 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e0:	8f450513          	addi	a0,a0,-1804 # 70d0 <malloc+0x1b98>
    ...
    37fc:	8d850513          	addi	a0,a0,-1832 # 70d0 <malloc+0x1b98>
...
0000000000003810 <killstatus>:
{
  ...
  exit(0);
    ...
    386a:	69250513          	addi	a0,a0,1682 # 5ef8 <malloc+0x9c0>
    386e:	413010ef          	jal	5480 <printf>
      exit(1);
    3872:	4505                	li	a0,1
    ...
    3884:	86050513          	addi	a0,a0,-1952 # 70e0 <malloc+0x1ba8>
    3888:	3f9010ef          	jal	5480 <printf>
       exit(1);
    388c:	4505                	li	a0,1
...
0000000000003892 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    38b8:	80450513          	addi	a0,a0,-2044 # 60b8 <malloc+0xb80>
    38bc:	3c5010ef          	jal	5480 <printf>
    exit(1);
    38c0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    38da:	62250513          	addi	a0,a0,1570 # 5ef8 <malloc+0x9c0>
    38de:	3a3010ef          	jal	5480 <printf>
    exit(1);
    38e2:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    390a:	dd258593          	addi	a1,a1,-558 # 56d8 <malloc+0x1a0>
    ...
    392c:	5d050513          	addi	a0,a0,1488 # 5ef8 <malloc+0x9c0>
    3930:	351010ef          	jal	5480 <printf>
     exit(1);
    3934:	4505                	li	a0,1
    ...
    3940:	7c450513          	addi	a0,a0,1988 # 7100 <malloc+0x1bc8>
    3944:	33d010ef          	jal	5480 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3970:	7ac50513          	addi	a0,a0,1964 # 7118 <malloc+0x1be0>
    3974:	30d010ef          	jal	5480 <printf>
}
  ...
  printf("kill... ");
    ...
    3994:	7a050513          	addi	a0,a0,1952 # 7130 <malloc+0x1bf8>
    3998:	2e9010ef          	jal	5480 <printf>
  kill(pid1);
    399c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    39b2:	79250513          	addi	a0,a0,1938 # 7140 <malloc+0x1c08>
    39b6:	2cb010ef          	jal	5480 <printf>
  wait(0);
    39ba:	4501                	li	a0,0
...
00000000000039ce <reparent>:
{
  ...
  exit(0);
    ...
    3a12:	4ea50513          	addi	a0,a0,1258 # 5ef8 <malloc+0x9c0>
    3a16:	26b010ef          	jal	5480 <printf>
      exit(1);
    3a1a:	4505                	li	a0,1
    ...
    3a26:	65e50513          	addi	a0,a0,1630 # 6080 <malloc+0xb48>
    3a2a:	257010ef          	jal	5480 <printf>
        exit(1);
    3a2e:	4505                	li	a0,1
...
0000000000003a4e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3a8e:	57650513          	addi	a0,a0,1398 # 6000 <malloc+0xac8>
    3a92:	1ef010ef          	jal	5480 <printf>
    exit(1);
    3a96:	4505                	li	a0,1
    ...
    3ab8:	e1458593          	addi	a1,a1,-492 # 78c8 <malloc+0x2390>
    ...
    3ad6:	67e58593          	addi	a1,a1,1662 # 7150 <malloc+0x1c18>
  ...
  c = sbrk(PGSIZE);
    ...
    3b30:	62c50513          	addi	a0,a0,1580 # 7158 <malloc+0x1c20>
    3b34:	14d010ef          	jal	5480 <printf>
  ...
  if(pid == 0){
    ...
    3b7a:	63250513          	addi	a0,a0,1586 # 71a8 <malloc+0x1c70>
    3b7e:	103010ef          	jal	5480 <printf>
    exit(1);
    3b82:	4505                	li	a0,1
    ...
    3b8e:	5fe50513          	addi	a0,a0,1534 # 7188 <malloc+0x1c50>
    3b92:	0ef010ef          	jal	5480 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba2:	35a50513          	addi	a0,a0,858 # 5ef8 <malloc+0x9c0>
    3ba6:	0db010ef          	jal	5480 <printf>
    exit(1);
    3baa:	4505                	li	a0,1
...
0000000000003be2 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3c26:	6084                	ld	s1,0(s1)
      free(m1);
    3c28:	08b010ef          	jal	54b2 <free>
    while(m1){
    3c2c:	fce5                	bnez	s1,3c24 <mem+0x42>
    m1 = malloc(1024*20);
    3c2e:	6515                	lui	a0,0x5
    3c30:	109010ef          	jal	5538 <malloc>
    if(m1 == 0){
    3c34:	c511                	beqz	a0,3c40 <mem+0x5e>
    free(m1);
    3c36:	07d010ef          	jal	54b2 <free>
    exit(0);
    3c3a:	4501                	li	a0,0
    ...
    3c46:	59650513          	addi	a0,a0,1430 # 71d8 <malloc+0x1ca0>
    3c4a:	037010ef          	jal	5480 <printf>
      exit(1);
    3c4e:	4505                	li	a0,1
...
0000000000003c5a <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3c6e:	58e50513          	addi	a0,a0,1422 # 71f8 <malloc+0x1cc0>
    3c72:	3c8010ef          	jal	503a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3c76:	20200593          	li	a1,514
    3c7a:	00003517          	auipc	a0,0x3
    3c7e:	57e50513          	addi	a0,a0,1406 # 71f8 <malloc+0x1cc0>
  ...
  if(pid == 0) {
    ...
    3ce6:	52650513          	addi	a0,a0,1318 # 7208 <malloc+0x1cd0>
    3cea:	796010ef          	jal	5480 <printf>
    exit(1);
    3cee:	4505                	li	a0,1
    ...
    3cfc:	53850513          	addi	a0,a0,1336 # 7230 <malloc+0x1cf8>
    3d00:	780010ef          	jal	5480 <printf>
      exit(1);
    3d04:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3d30:	4cc50513          	addi	a0,a0,1228 # 71f8 <malloc+0x1cc0>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d68:	4ec50513          	addi	a0,a0,1260 # 7250 <malloc+0x1d18>
    3d6c:	714010ef          	jal	5480 <printf>
    exit(1);
    3d70:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3d98:	46450513          	addi	a0,a0,1124 # 71f8 <malloc+0x1cc0>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3dba:	4c250513          	addi	a0,a0,1218 # 7278 <malloc+0x1d40>
    3dbe:	6c2010ef          	jal	5480 <printf>
    exit(1);
    3dc2:	4505                	li	a0,1
...
0000000000003dc8 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3dec:	4a878793          	addi	a5,a5,1192 # 7290 <malloc+0x1d58>
    3df0:	f6f43823          	sd	a5,-144(s0)
    3df4:	00003797          	auipc	a5,0x3
    3df8:	4a478793          	addi	a5,a5,1188 # 7298 <malloc+0x1d60>
    3dfc:	f6f43c23          	sd	a5,-136(s0)
    3e00:	00003797          	auipc	a5,0x3
    3e04:	4a078793          	addi	a5,a5,1184 # 72a0 <malloc+0x1d68>
    3e08:	f8f43023          	sd	a5,-128(s0)
    3e0c:	00003797          	auipc	a5,0x3
    3e10:	49c78793          	addi	a5,a5,1180 # 72a8 <malloc+0x1d70>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e76:	08650513          	addi	a0,a0,134 # 5ef8 <malloc+0x9c0>
    3e7a:	606010ef          	jal	5480 <printf>
      exit(1);
    3e7e:	4505                	li	a0,1
    ...
    3ed6:	0be50513          	addi	a0,a0,190 # 5f90 <malloc+0xa58>
    3eda:	5a6010ef          	jal	5480 <printf>
        exit(1);
    3ede:	4505                	li	a0,1
    3ee0:	10a010ef          	jal	4fea <exit>
          printf("write failed %d\n", n);
    3ee4:	00003517          	auipc	a0,0x3
    3ee8:	3cc50513          	addi	a0,a0,972 # 72b0 <malloc+0x1d78>
    3eec:	594010ef          	jal	5480 <printf>
          exit(1);
    3ef0:	4505                	li	a0,1
    ...
    3f02:	3ca50513          	addi	a0,a0,970 # 72c8 <malloc+0x1d90>
    3f06:	57a010ef          	jal	5480 <printf>
          exit(1);
    3f0a:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f6c:	37050513          	addi	a0,a0,880 # 72d8 <malloc+0x1da0>
    3f70:	510010ef          	jal	5480 <printf>
      exit(1);
    3f74:	4505                	li	a0,1
...
0000000000003f98 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3fda:	31ac8c93          	addi	s9,s9,794 # 72f0 <malloc+0x1db8>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    402e:	2ce50513          	addi	a0,a0,718 # 72f8 <malloc+0x1dc0>
    4032:	44e010ef          	jal	5480 <printf>
        exit(1);
    4036:	4505                	li	a0,1
    ...
    4044:	2b050513          	addi	a0,a0,688 # 72f0 <malloc+0x1db8>
  ...
  fd = open(".", 0);
    ...
    406c:	ce850513          	addi	a0,a0,-792 # 5d50 <malloc+0x818>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    40da:	24250513          	addi	a0,a0,578 # 7318 <malloc+0x1de0>
    40de:	3a2010ef          	jal	5480 <printf>
        exit(1);
    40e2:	4505                	li	a0,1
    ...
    40f2:	24a50513          	addi	a0,a0,586 # 7338 <malloc+0x1e00>
    40f6:	38a010ef          	jal	5480 <printf>
        exit(1);
    40fa:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4124:	24050513          	addi	a0,a0,576 # 7360 <malloc+0x1e28>
    4128:	358010ef          	jal	5480 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    4138:	dc450513          	addi	a0,a0,-572 # 5ef8 <malloc+0x9c0>
    413c:	344010ef          	jal	5480 <printf>
      exit(1);
    4140:	4505                	li	a0,1
...
0000000000004278 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4292:	10a50513          	addi	a0,a0,266 # 7398 <malloc+0x1e60>
    4296:	5a5000ef          	jal	503a <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    429a:	20200593          	li	a1,514
    429e:	00003517          	auipc	a0,0x3
    42a2:	0fa50513          	addi	a0,a0,250 # 7398 <malloc+0x1e60>
  ...
  fd = open("bigfile.dat", 0);
    ...
    42ea:	0b250513          	addi	a0,a0,178 # 7398 <malloc+0x1e60>
  ...
  for(i = 0; ; i++){
    ...
    4344:	06850513          	addi	a0,a0,104 # 73a8 <malloc+0x1e70>
    4348:	138010ef          	jal	5480 <printf>
    exit(1);
    434c:	4505                	li	a0,1
    ...
    4358:	07450513          	addi	a0,a0,116 # 73c8 <malloc+0x1e90>
    435c:	124010ef          	jal	5480 <printf>
      exit(1);
    4360:	4505                	li	a0,1
    ...
    436c:	08050513          	addi	a0,a0,128 # 73e8 <malloc+0x1eb0>
    4370:	110010ef          	jal	5480 <printf>
    exit(1);
    4374:	4505                	li	a0,1
    ...
    4380:	08c50513          	addi	a0,a0,140 # 7408 <malloc+0x1ed0>
    4384:	0fc010ef          	jal	5480 <printf>
      exit(1);
    4388:	4505                	li	a0,1
    ...
    4394:	09850513          	addi	a0,a0,152 # 7428 <malloc+0x1ef0>
    4398:	0e8010ef          	jal	5480 <printf>
      exit(1);
    439c:	4505                	li	a0,1
    ...
    43a8:	09c50513          	addi	a0,a0,156 # 7440 <malloc+0x1f08>
    43ac:	0d4010ef          	jal	5480 <printf>
      exit(1);
    43b0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    43ca:	fd250513          	addi	a0,a0,-46 # 7398 <malloc+0x1e60>
    ...
    43ec:	07850513          	addi	a0,a0,120 # 7460 <malloc+0x1f28>
    43f0:	090010ef          	jal	5480 <printf>
    exit(1);
    43f4:	4505                	li	a0,1
...
00000000000043fa <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    440a:	07a50513          	addi	a0,a0,122 # 7480 <malloc+0x1f48>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4430:	05450513          	addi	a0,a0,84 # 7480 <malloc+0x1f48>
  ...
  close(fd);
    ...
    448e:	1de50513          	addi	a0,a0,478 # 5668 <malloc+0x130>
    4492:	391000ef          	jal	5022 <exec>
    fd = open("bigarg-ok", O_CREATE);
    4496:	20000593          	li	a1,512
    449a:	00003517          	auipc	a0,0x3
    449e:	fe650513          	addi	a0,a0,-26 # 7480 <malloc+0x1f48>
    ...
    44b6:	fde50513          	addi	a0,a0,-34 # 7490 <malloc+0x1f58>
    44ba:	7c7000ef          	jal	5480 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	fe650513          	addi	a0,a0,-26 # 74b0 <malloc+0x1f78>
    44d2:	7af000ef          	jal	5480 <printf>
    exit(1);
    44d6:	4505                	li	a0,1
...
00000000000044dc <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4526:	fae50513          	addi	a0,a0,-82 # 74d0 <malloc+0x1f98>
    452a:	757000ef          	jal	5480 <printf>
    exit(1);
    452e:	4505                	li	a0,1
    4530:	2bb000ef          	jal	4fea <exit>
      printf("failed to read value from memory\n");
    4534:	00003517          	auipc	a0,0x3
    4538:	fb450513          	addi	a0,a0,-76 # 74e8 <malloc+0x1fb0>
    453c:	745000ef          	jal	5480 <printf>
      exit(1);
    4540:	4505                	li	a0,1
...
0000000000004546 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    45b4:	f2050513          	addi	a0,a0,-224 # 74d0 <malloc+0x1f98>
    45b8:	6c9000ef          	jal	5480 <printf>
    exit(1);
    45bc:	4505                	li	a0,1
    45be:	22d000ef          	jal	4fea <exit>
      printf("error forking\n");
    45c2:	00003517          	auipc	a0,0x3
    45c6:	f4e50513          	addi	a0,a0,-178 # 7510 <malloc+0x1fd8>
    45ca:	6b7000ef          	jal	5480 <printf>
      exit(1);
    45ce:	4505                	li	a0,1
    ...
    45ea:	f3a50513          	addi	a0,a0,-198 # 7520 <malloc+0x1fe8>
    45ee:	693000ef          	jal	5480 <printf>
        exit(1);
    45f2:	4505                	li	a0,1
...
00000000000045f8 <lazy_copy>:
{
    ...
    4642:	efa50513          	addi	a0,a0,-262 # 7538 <malloc+0x2000>
    4646:	63b000ef          	jal	5480 <printf>
      exit(1);
    464a:	4505                	li	a0,1
    464c:	19f000ef          	jal	4fea <exit>
  unsigned long bad[] = {
    4650:	00003797          	auipc	a5,0x3
    4654:	56078793          	addi	a5,a5,1376 # 7bb0 <malloc+0x2678>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    4684:	1c0a8a93          	addi	s5,s5,448 # 5840 <malloc+0x308>
    ...
    4694:	0c0b0b13          	addi	s6,s6,192 # 5750 <malloc+0x218>
    int fd = open("README", 0);
    4698:	4581                	li	a1,0
    469a:	8556                	mv	a0,s5
  ...
  exit(0);
    ...
    46f0:	e7c50513          	addi	a0,a0,-388 # 7568 <malloc+0x2030>
    46f4:	58d000ef          	jal	5480 <printf>
    46f8:	4505                	li	a0,1
    46fa:	0f1000ef          	jal	4fea <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    46fe:	00003517          	auipc	a0,0x3
    4702:	e8250513          	addi	a0,a0,-382 # 7580 <malloc+0x2048>
    4706:	57b000ef          	jal	5480 <printf>
    470a:	4505                	li	a0,1
    470c:	0df000ef          	jal	4fea <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4710:	00003517          	auipc	a0,0x3
    4714:	e8050513          	addi	a0,a0,-384 # 7590 <malloc+0x2058>
    4718:	569000ef          	jal	5480 <printf>
    471c:	4505                	li	a0,1
    471e:	0cd000ef          	jal	4fea <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4722:	00003517          	auipc	a0,0x3
    4726:	e8650513          	addi	a0,a0,-378 # 75a8 <malloc+0x2070>
    472a:	557000ef          	jal	5480 <printf>
    472e:	4505                	li	a0,1
...
0000000000004734 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    4786:	e3e50513          	addi	a0,a0,-450 # 75c0 <malloc+0x2088>
    478a:	4f7000ef          	jal	5480 <printf>
    exit(1);
    478e:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    47ae:	e4650513          	addi	a0,a0,-442 # 75f0 <malloc+0x20b8>
    47b2:	4cf000ef          	jal	5480 <printf>
    exit(1);
    47b6:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    47d4:	e5850513          	addi	a0,a0,-424 # 7628 <malloc+0x20f0>
    47d8:	4a9000ef          	jal	5480 <printf>
    exit(1);
    47dc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    47f4:	e6050513          	addi	a0,a0,-416 # 7650 <malloc+0x2118>
    47f8:	489000ef          	jal	5480 <printf>
    exit(1);
    47fc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4814:	e6850513          	addi	a0,a0,-408 # 7678 <malloc+0x2140>
    4818:	469000ef          	jal	5480 <printf>
    exit(1);
    481c:	4505                	li	a0,1
...
0000000000004828 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    484a:	e6250513          	addi	a0,a0,-414 # 76a8 <malloc+0x2170>
    484e:	433000ef          	jal	5480 <printf>
  for(nfiles = 0; ; nfiles++){
    4852:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4900:	dbc50513          	addi	a0,a0,-580 # 76b8 <malloc+0x2180>
    4904:	37d000ef          	jal	5480 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4920:	dac50513          	addi	a0,a0,-596 # 76c8 <malloc+0x2190>
    4924:	35d000ef          	jal	5480 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    49e4:	d0850513          	addi	a0,a0,-760 # 76e8 <malloc+0x21b0>
    49e8:	299000ef          	jal	5480 <printf>
}
    ...
    4a36:	ca650513          	addi	a0,a0,-858 # 76d8 <malloc+0x21a0>
    4a3a:	247000ef          	jal	5480 <printf>
    close(fd);
    4a3e:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4a60:	ca450513          	addi	a0,a0,-860 # 7700 <malloc+0x21c8>
    4a64:	21d000ef          	jal	5480 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4a84:	ca850513          	addi	a0,a0,-856 # 7728 <malloc+0x21f0>
    4a88:	1f9000ef          	jal	5480 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4aa4:	c7050513          	addi	a0,a0,-912 # 7710 <malloc+0x21d8>
    4aa8:	1d9000ef          	jal	5480 <printf>
    exit(1);
    4aac:	4505                	li	a0,1
    ...
    4ac0:	c7450513          	addi	a0,a0,-908 # 7730 <malloc+0x21f8>
    4ac4:	1bd000ef          	jal	5480 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    4b12:	c2a50513          	addi	a0,a0,-982 # 7738 <malloc+0x2200>
    4b16:	16b000ef          	jal	5480 <printf>
          return -1;
    4b1a:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
    ...
    4bb0:	ba4c0c13          	addi	s8,s8,-1116 # 7750 <malloc+0x2218>
    ...
    4bca:	bc2d8d93          	addi	s11,s11,-1086 # 7788 <malloc+0x2250>
    ...
    4bdc:	b9050513          	addi	a0,a0,-1136 # 7768 <malloc+0x2230>
    4be0:	0a1000ef          	jal	5480 <printf>
    ...
    4c4e:	b6e50513          	addi	a0,a0,-1170 # 77b8 <malloc+0x2280>
    4c52:	02f000ef          	jal	5480 <printf>
      return 1;
    4c56:	4505                	li	a0,1
  return 0;
}
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4cb4:	b2058593          	addi	a1,a1,-1248 # 77d0 <malloc+0x2298>
  ...
  int continuous = 0;
    ...
    4d08:	adc50513          	addi	a0,a0,-1316 # 77e0 <malloc+0x22a8>
    4d0c:	774000ef          	jal	5480 <printf>
    exit(1);
    4d10:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4d26:	aee50513          	addi	a0,a0,-1298 # 7810 <malloc+0x22d8>
    4d2a:	756000ef          	jal	5480 <printf>
  exit(0);
    4d2e:	4501                	li	a0,0
...
00000000000050b2 <getchildsyscount>:
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    5106:	c6d1                	beqz	a3,5192 <printint+0x9a>
    5108:	0805d563          	bgez	a1,5192 <printint+0x9a>
    neg = 1;
    x = -xx;
    510c:	40b005b3          	neg	a1,a1
    neg = 1;
    5110:	4305                	li	t1,1
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    511a:	00003817          	auipc	a6,0x3
    511e:	b3e80813          	addi	a6,a6,-1218 # 7c58 <digits>
    5122:	88ba                	mv	a7,a4
    5124:	0017051b          	addiw	a0,a4,1
    5128:	872a                	mv	a4,a0
    512a:	02c5f7b3          	remu	a5,a1,a2
    512e:	97c2                	add	a5,a5,a6
    5130:	0007c783          	lbu	a5,0(a5)
    5134:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5138:	87ae                	mv	a5,a1
    513a:	02c5d5b3          	divu	a1,a1,a2
    513e:	0685                	addi	a3,a3,1
    5140:	fec7f1e3          	bgeu	a5,a2,5122 <printint+0x2a>
  if(neg)
    5144:	00030c63          	beqz	t1,515c <printint+0x64>
    buf[i++] = '-';
    5148:	fd050793          	addi	a5,a0,-48
    514c:	00878533          	add	a0,a5,s0
    5150:	02d00793          	li	a5,45
    5154:	fef50423          	sb	a5,-24(a0)
    5158:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
    515c:	02e05563          	blez	a4,5186 <printint+0x8e>
    5160:	fc26                	sd	s1,56(sp)
    5162:	377d                	addiw	a4,a4,-1
    5164:	00e984b3          	add	s1,s3,a4
    5168:	19fd                	addi	s3,s3,-1 # fff <bigdir+0x10b>
    516a:	99ba                	add	s3,s3,a4
    516c:	1702                	slli	a4,a4,0x20
    516e:	9301                	srli	a4,a4,0x20
    5170:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5174:	0004c583          	lbu	a1,0(s1)
    5178:	854a                	mv	a0,s2
    517a:	f61ff0ef          	jal	50da <putc>
  while(--i >= 0)
    517e:	14fd                	addi	s1,s1,-1
    5180:	ff349ae3          	bne	s1,s3,5174 <printint+0x7c>
    5184:	74e2                	ld	s1,56(sp)
}
    5186:	60a6                	ld	ra,72(sp)
    5188:	6406                	ld	s0,64(sp)
    518a:	7942                	ld	s2,48(sp)
    518c:	79a2                	ld	s3,40(sp)
    518e:	6161                	addi	sp,sp,80
    5190:	8082                	ret
  neg = 0;
    5192:	4301                	li	t1,0
    5194:	bfbd                	j	5112 <printint+0x1a>

0000000000005196 <vprintf>:
}
...
{
    5196:	711d                	addi	sp,sp,-96
    5198:	ec86                	sd	ra,88(sp)
    519a:	e8a2                	sd	s0,80(sp)
    519c:	e4a6                	sd	s1,72(sp)
    519e:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    51a0:	0005c483          	lbu	s1,0(a1)
    51a4:	22048363          	beqz	s1,53ca <vprintf+0x234>
    51a8:	e0ca                	sd	s2,64(sp)
    51aa:	fc4e                	sd	s3,56(sp)
    51ac:	f852                	sd	s4,48(sp)
    51ae:	f456                	sd	s5,40(sp)
    51b0:	f05a                	sd	s6,32(sp)
    51b2:	ec5e                	sd	s7,24(sp)
    51b4:	e862                	sd	s8,16(sp)
    51b6:	8b2a                	mv	s6,a0
    51b8:	8a2e                	mv	s4,a1
    51ba:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    51c2:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    51c6:	06400c13          	li	s8,100
    51ca:	a00d                	j	51ec <vprintf+0x56>
        putc(fd, c0);
    51cc:	85a6                	mv	a1,s1
    51ce:	855a                	mv	a0,s6
    51d0:	f0bff0ef          	jal	50da <putc>
    51d4:	a019                	j	51da <vprintf+0x44>
    } else if(state == '%'){
    51d6:	03598363          	beq	s3,s5,51fc <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
    51da:	0019079b          	addiw	a5,s2,1
    51de:	893e                	mv	s2,a5
    51e0:	873e                	mv	a4,a5
    51e2:	97d2                	add	a5,a5,s4
    51e4:	0007c483          	lbu	s1,0(a5)
    51e8:	1c048a63          	beqz	s1,53bc <vprintf+0x226>
    c0 = fmt[i] & 0xff;
    51ec:	0004879b          	sext.w	a5,s1
    if(state == 0){
    51f0:	fe0993e3          	bnez	s3,51d6 <vprintf+0x40>
      if(c0 == '%'){
    51f4:	fd579ce3          	bne	a5,s5,51cc <vprintf+0x36>
        state = '%';
    51f8:	89be                	mv	s3,a5
    51fa:	b7c5                	j	51da <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
    51fc:	00ea06b3          	add	a3,s4,a4
    5200:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
    5204:	1c060863          	beqz	a2,53d4 <vprintf+0x23e>
      if(c0 == 'd'){
    5208:	03878763          	beq	a5,s8,5236 <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    520c:	f9478693          	addi	a3,a5,-108
    5210:	0016b693          	seqz	a3,a3
    5214:	f9c60593          	addi	a1,a2,-100
    5218:	e99d                	bnez	a1,524e <vprintf+0xb8>
    521a:	ca95                	beqz	a3,524e <vprintf+0xb8>
        printint(fd, va_arg(ap, uint64), 10, 1);
    521c:	008b8493          	addi	s1,s7,8
    5220:	4685                	li	a3,1
    5222:	4629                	li	a2,10
    5224:	000bb583          	ld	a1,0(s7)
    5228:	855a                	mv	a0,s6
    522a:	ecfff0ef          	jal	50f8 <printint>
        i += 1;
    522e:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    5230:	8ba6                	mv	s7,s1
      ...
      state = 0;
    5232:	4981                	li	s3,0
    5234:	b75d                	j	51da <vprintf+0x44>
        printint(fd, va_arg(ap, int), 10, 1);
    5236:	008b8493          	addi	s1,s7,8
    523a:	4685                	li	a3,1
    523c:	4629                	li	a2,10
    523e:	000ba583          	lw	a1,0(s7)
    5242:	855a                	mv	a0,s6
    5244:	eb5ff0ef          	jal	50f8 <printint>
    5248:	8ba6                	mv	s7,s1
      state = 0;
    524a:	4981                	li	s3,0
    524c:	b779                	j	51da <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
    524e:	9752                	add	a4,a4,s4
    5250:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5254:	f9460713          	addi	a4,a2,-108
    5258:	00173713          	seqz	a4,a4
    525c:	8f75                	and	a4,a4,a3
    525e:	f9c58513          	addi	a0,a1,-100
    5262:	18051363          	bnez	a0,53e8 <vprintf+0x252>
    5266:	18070163          	beqz	a4,53e8 <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
    526a:	008b8493          	addi	s1,s7,8
    526e:	4685                	li	a3,1
    5270:	4629                	li	a2,10
    5272:	000bb583          	ld	a1,0(s7)
    5276:	855a                	mv	a0,s6
    5278:	e81ff0ef          	jal	50f8 <printint>
        i += 2;
    527c:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    527e:	8ba6                	mv	s7,s1
      state = 0;
    5280:	4981                	li	s3,0
        i += 2;
    5282:	bfa1                	j	51da <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 10, 0);
    5284:	008b8493          	addi	s1,s7,8
    5288:	4681                	li	a3,0
    528a:	4629                	li	a2,10
    528c:	000be583          	lwu	a1,0(s7)
    5290:	855a                	mv	a0,s6
    5292:	e67ff0ef          	jal	50f8 <printint>
    5296:	8ba6                	mv	s7,s1
      state = 0;
    5298:	4981                	li	s3,0
    529a:	b781                	j	51da <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    529c:	008b8493          	addi	s1,s7,8
    52a0:	4681                	li	a3,0
    52a2:	4629                	li	a2,10
    52a4:	000bb583          	ld	a1,0(s7)
    52a8:	855a                	mv	a0,s6
    52aa:	e4fff0ef          	jal	50f8 <printint>
        i += 1;
    52ae:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    52b0:	8ba6                	mv	s7,s1
      state = 0;
    52b2:	4981                	li	s3,0
    52b4:	b71d                	j	51da <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    52b6:	008b8493          	addi	s1,s7,8
    52ba:	4681                	li	a3,0
    52bc:	4629                	li	a2,10
    52be:	000bb583          	ld	a1,0(s7)
    52c2:	855a                	mv	a0,s6
    52c4:	e35ff0ef          	jal	50f8 <printint>
        i += 2;
    52c8:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    52ca:	8ba6                	mv	s7,s1
      state = 0;
    52cc:	4981                	li	s3,0
        i += 2;
    52ce:	b731                	j	51da <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 16, 0);
    52d0:	008b8493          	addi	s1,s7,8
    52d4:	4681                	li	a3,0
    52d6:	4641                	li	a2,16
    52d8:	000be583          	lwu	a1,0(s7)
    52dc:	855a                	mv	a0,s6
    52de:	e1bff0ef          	jal	50f8 <printint>
    52e2:	8ba6                	mv	s7,s1
      state = 0;
    52e4:	4981                	li	s3,0
    52e6:	bdd5                	j	51da <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    52e8:	008b8493          	addi	s1,s7,8
    52ec:	4681                	li	a3,0
    52ee:	4641                	li	a2,16
    52f0:	000bb583          	ld	a1,0(s7)
    52f4:	855a                	mv	a0,s6
    52f6:	e03ff0ef          	jal	50f8 <printint>
        i += 1;
    52fa:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    52fc:	8ba6                	mv	s7,s1
      state = 0;
    52fe:	4981                	li	s3,0
    5300:	bde9                	j	51da <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    5302:	008b8493          	addi	s1,s7,8
    5306:	4681                	li	a3,0
    5308:	4641                	li	a2,16
    530a:	000bb583          	ld	a1,0(s7)
    530e:	855a                	mv	a0,s6
    5310:	de9ff0ef          	jal	50f8 <printint>
        i += 2;
    5314:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    5316:	8ba6                	mv	s7,s1
      state = 0;
    5318:	4981                	li	s3,0
        i += 2;
    531a:	b5c1                	j	51da <vprintf+0x44>
    531c:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
    531e:	008b8793          	addi	a5,s7,8
    5322:	8cbe                	mv	s9,a5
    5324:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5328:	03000593          	li	a1,48
    532c:	855a                	mv	a0,s6
    532e:	dadff0ef          	jal	50da <putc>
  putc(fd, 'x');
    5332:	07800593          	li	a1,120
    5336:	855a                	mv	a0,s6
    5338:	da3ff0ef          	jal	50da <putc>
    533c:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    533e:	00003b97          	auipc	s7,0x3
    5342:	91ab8b93          	addi	s7,s7,-1766 # 7c58 <digits>
    5346:	03c9d793          	srli	a5,s3,0x3c
    534a:	97de                	add	a5,a5,s7
    534c:	0007c583          	lbu	a1,0(a5)
    5350:	855a                	mv	a0,s6
    5352:	d89ff0ef          	jal	50da <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5356:	0992                	slli	s3,s3,0x4
    5358:	34fd                	addiw	s1,s1,-1
    535a:	f4f5                	bnez	s1,5346 <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
    535c:	8be6                	mv	s7,s9
      state = 0;
    535e:	4981                	li	s3,0
    5360:	6ca2                	ld	s9,8(sp)
    5362:	bda5                	j	51da <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
    5364:	008b8493          	addi	s1,s7,8
    5368:	000bc583          	lbu	a1,0(s7)
    536c:	855a                	mv	a0,s6
    536e:	d6dff0ef          	jal	50da <putc>
    5372:	8ba6                	mv	s7,s1
      state = 0;
    5374:	4981                	li	s3,0
    5376:	b595                	j	51da <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    5378:	008b8993          	addi	s3,s7,8
    537c:	000bb483          	ld	s1,0(s7)
    5380:	cc91                	beqz	s1,539c <vprintf+0x206>
        for(; *s; s++)
    5382:	0004c583          	lbu	a1,0(s1)
    5386:	c985                	beqz	a1,53b6 <vprintf+0x220>
          putc(fd, *s);
    5388:	855a                	mv	a0,s6
    538a:	d51ff0ef          	jal	50da <putc>
        for(; *s; s++)
    538e:	0485                	addi	s1,s1,1
    5390:	0004c583          	lbu	a1,0(s1)
    5394:	f9f5                	bnez	a1,5388 <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
    5396:	8bce                	mv	s7,s3
      state = 0;
    5398:	4981                	li	s3,0
    539a:	b581                	j	51da <vprintf+0x44>
          s = "(null)";
    539c:	00003497          	auipc	s1,0x3
    53a0:	80c48493          	addi	s1,s1,-2036 # 7ba8 <malloc+0x2670>
        for(; *s; s++)
    53a4:	02800593          	li	a1,40
    53a8:	b7c5                	j	5388 <vprintf+0x1f2>
        putc(fd, '%');
    53aa:	85be                	mv	a1,a5
    53ac:	855a                	mv	a0,s6
    53ae:	d2dff0ef          	jal	50da <putc>
      state = 0;
    53b2:	4981                	li	s3,0
    53b4:	b51d                	j	51da <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    53b6:	8bce                	mv	s7,s3
      state = 0;
    53b8:	4981                	li	s3,0
    53ba:	b505                	j	51da <vprintf+0x44>
    53bc:	6906                	ld	s2,64(sp)
    53be:	79e2                	ld	s3,56(sp)
    53c0:	7a42                	ld	s4,48(sp)
    53c2:	7aa2                	ld	s5,40(sp)
    53c4:	7b02                	ld	s6,32(sp)
    53c6:	6be2                	ld	s7,24(sp)
    53c8:	6c42                	ld	s8,16(sp)
    }
  }
}
    53ca:	60e6                	ld	ra,88(sp)
    53cc:	6446                	ld	s0,80(sp)
    53ce:	64a6                	ld	s1,72(sp)
    53d0:	6125                	addi	sp,sp,96
    53d2:	8082                	ret
      if(c0 == 'd'){
    53d4:	06400713          	li	a4,100
    53d8:	e4e78fe3          	beq	a5,a4,5236 <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
    53dc:	f9478693          	addi	a3,a5,-108
    53e0:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
    53e4:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    53e6:	4701                	li	a4,0
      } else if(c0 == 'u'){
    53e8:	07500513          	li	a0,117
    53ec:	e8a78ce3          	beq	a5,a0,5284 <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
    53f0:	f8b60513          	addi	a0,a2,-117
    53f4:	e119                	bnez	a0,53fa <vprintf+0x264>
    53f6:	ea0693e3          	bnez	a3,529c <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    53fa:	f8b58513          	addi	a0,a1,-117
    53fe:	e119                	bnez	a0,5404 <vprintf+0x26e>
    5400:	ea071be3          	bnez	a4,52b6 <vprintf+0x120>
      } else if(c0 == 'x'){
    5404:	07800513          	li	a0,120
    5408:	eca784e3          	beq	a5,a0,52d0 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
    540c:	f8860613          	addi	a2,a2,-120
    5410:	e219                	bnez	a2,5416 <vprintf+0x280>
    5412:	ec069be3          	bnez	a3,52e8 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    5416:	f8858593          	addi	a1,a1,-120
    541a:	e199                	bnez	a1,5420 <vprintf+0x28a>
    541c:	ee0713e3          	bnez	a4,5302 <vprintf+0x16c>
      } else if(c0 == 'p'){
    5420:	07000713          	li	a4,112
    5424:	eee78ce3          	beq	a5,a4,531c <vprintf+0x186>
      } else if(c0 == 'c'){
    5428:	06300713          	li	a4,99
    542c:	f2e78ce3          	beq	a5,a4,5364 <vprintf+0x1ce>
      } else if(c0 == 's'){
    5430:	07300713          	li	a4,115
    5434:	f4e782e3          	beq	a5,a4,5378 <vprintf+0x1e2>
      } else if(c0 == '%'){
    5438:	02500713          	li	a4,37
    543c:	f6e787e3          	beq	a5,a4,53aa <vprintf+0x214>
        putc(fd, '%');
    5440:	02500593          	li	a1,37
    5444:	855a                	mv	a0,s6
    5446:	c95ff0ef          	jal	50da <putc>
        putc(fd, c0);
    544a:	85a6                	mv	a1,s1
    544c:	855a                	mv	a0,s6
    544e:	c8dff0ef          	jal	50da <putc>
      state = 0;
    5452:	4981                	li	s3,0
    5454:	b359                	j	51da <vprintf+0x44>

0000000000005456 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5456:	715d                	addi	sp,sp,-80
    5458:	ec06                	sd	ra,24(sp)
    545a:	e822                	sd	s0,16(sp)
    545c:	1000                	addi	s0,sp,32
    545e:	e010                	sd	a2,0(s0)
    5460:	e414                	sd	a3,8(s0)
    5462:	e818                	sd	a4,16(s0)
    5464:	ec1c                	sd	a5,24(s0)
    5466:	03043023          	sd	a6,32(s0)
    546a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    546e:	8622                	mv	a2,s0
    5470:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5474:	d23ff0ef          	jal	5196 <vprintf>
}
    5478:	60e2                	ld	ra,24(sp)
    547a:	6442                	ld	s0,16(sp)
    547c:	6161                	addi	sp,sp,80
    547e:	8082                	ret

0000000000005480 <printf>:

void
printf(const char *fmt, ...)
{
    5480:	711d                	addi	sp,sp,-96
    5482:	ec06                	sd	ra,24(sp)
    5484:	e822                	sd	s0,16(sp)
    5486:	1000                	addi	s0,sp,32
    5488:	e40c                	sd	a1,8(s0)
    548a:	e810                	sd	a2,16(s0)
    548c:	ec14                	sd	a3,24(s0)
    548e:	f018                	sd	a4,32(s0)
    5490:	f41c                	sd	a5,40(s0)
    5492:	03043823          	sd	a6,48(s0)
    5496:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    549a:	00840613          	addi	a2,s0,8
    549e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    54a2:	85aa                	mv	a1,a0
    54a4:	4505                	li	a0,1
    54a6:	cf1ff0ef          	jal	5196 <vprintf>
}
    54aa:	60e2                	ld	ra,24(sp)
    54ac:	6442                	ld	s0,16(sp)
    54ae:	6125                	addi	sp,sp,96
    54b0:	8082                	ret

00000000000054b2 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    54ba:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    54be:	00003797          	auipc	a5,0x3
    54c2:	fd27b783          	ld	a5,-46(a5) # 8490 <freep>
    54c6:	a039                	j	54d4 <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    54c8:	6398                	ld	a4,0(a5)
    54ca:	00e7e463          	bltu	a5,a4,54d2 <free+0x20>
    54ce:	00e6ea63          	bltu	a3,a4,54e2 <free+0x30>
{
    54d2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    54d4:	fed7fae3          	bgeu	a5,a3,54c8 <free+0x16>
    54d8:	6398                	ld	a4,0(a5)
    54da:	00e6e463          	bltu	a3,a4,54e2 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    54de:	fee7eae3          	bltu	a5,a4,54d2 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    54e2:	ff852583          	lw	a1,-8(a0)
    54e6:	6390                	ld	a2,0(a5)
    54e8:	02059813          	slli	a6,a1,0x20
    54ec:	01c85713          	srli	a4,a6,0x1c
    54f0:	9736                	add	a4,a4,a3
    54f2:	02e60563          	beq	a2,a4,551c <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    54f6:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    54fa:	4790                	lw	a2,8(a5)
    54fc:	02061593          	slli	a1,a2,0x20
    5500:	01c5d713          	srli	a4,a1,0x1c
    5504:	973e                	add	a4,a4,a5
    5506:	02e68263          	beq	a3,a4,552a <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    550a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    550c:	00003717          	auipc	a4,0x3
    5510:	f8f73223          	sd	a5,-124(a4) # 8490 <freep>
}
    5514:	60a2                	ld	ra,8(sp)
    5516:	6402                	ld	s0,0(sp)
    5518:	0141                	addi	sp,sp,16
    551a:	8082                	ret
    bp->s.size += p->s.ptr->s.size;
    551c:	4618                	lw	a4,8(a2)
    551e:	9f2d                	addw	a4,a4,a1
    5520:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5524:	6398                	ld	a4,0(a5)
    5526:	6310                	ld	a2,0(a4)
    5528:	b7f9                	j	54f6 <free+0x44>
    p->s.size += bp->s.size;
    552a:	ff852703          	lw	a4,-8(a0)
    552e:	9f31                	addw	a4,a4,a2
    5530:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5532:	ff053683          	ld	a3,-16(a0)
    5536:	bfd1                	j	550a <free+0x58>

0000000000005538 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5538:	7139                	addi	sp,sp,-64
    553a:	fc06                	sd	ra,56(sp)
    553c:	f822                	sd	s0,48(sp)
    553e:	f04a                	sd	s2,32(sp)
    5540:	ec4e                	sd	s3,24(sp)
    5542:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5544:	02051993          	slli	s3,a0,0x20
    5548:	0209d993          	srli	s3,s3,0x20
    554c:	09bd                	addi	s3,s3,15
    554e:	0049d993          	srli	s3,s3,0x4
    5552:	2985                	addiw	s3,s3,1
    5554:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    5556:	00003517          	auipc	a0,0x3
    555a:	f3a53503          	ld	a0,-198(a0) # 8490 <freep>
    555e:	c905                	beqz	a0,558e <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5560:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5562:	4798                	lw	a4,8(a5)
    5564:	09377663          	bgeu	a4,s3,55f0 <malloc+0xb8>
    5568:	f426                	sd	s1,40(sp)
    556a:	e852                	sd	s4,16(sp)
    556c:	e456                	sd	s5,8(sp)
    556e:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5570:	8a4e                	mv	s4,s3
    5572:	6705                	lui	a4,0x1
    5574:	00e9f363          	bgeu	s3,a4,557a <malloc+0x42>
    5578:	6a05                	lui	s4,0x1
    557a:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    557e:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5582:	00003497          	auipc	s1,0x3
    5586:	f0e48493          	addi	s1,s1,-242 # 8490 <freep>
  if(p == SBRK_ERROR)
    558a:	5afd                	li	s5,-1
    558c:	a83d                	j	55ca <malloc+0x92>
    558e:	f426                	sd	s1,40(sp)
    5590:	e852                	sd	s4,16(sp)
    5592:	e456                	sd	s5,8(sp)
    5594:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5596:	00009797          	auipc	a5,0x9
    559a:	72278793          	addi	a5,a5,1826 # ecb8 <base>
    559e:	00003717          	auipc	a4,0x3
    55a2:	eef73923          	sd	a5,-270(a4) # 8490 <freep>
    55a6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    55a8:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    55ac:	b7d1                	j	5570 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    55ae:	6398                	ld	a4,0(a5)
    55b0:	e118                	sd	a4,0(a0)
    55b2:	a899                	j	5608 <malloc+0xd0>
  hp->s.size = nu;
    55b4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    55b8:	0541                	addi	a0,a0,16
    55ba:	ef9ff0ef          	jal	54b2 <free>
  return freep;
    55be:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    55c0:	c125                	beqz	a0,5620 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    55c2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    55c4:	4798                	lw	a4,8(a5)
    55c6:	03277163          	bgeu	a4,s2,55e8 <malloc+0xb0>
    if(p == freep)
    55ca:	6098                	ld	a4,0(s1)
    55cc:	853e                	mv	a0,a5
    55ce:	fef71ae3          	bne	a4,a5,55c2 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    55d2:	8552                	mv	a0,s4
    55d4:	9e3ff0ef          	jal	4fb6 <sbrk>
  if(p == SBRK_ERROR)
    55d8:	fd551ee3          	bne	a0,s5,55b4 <malloc+0x7c>
        return 0;
    55dc:	4501                	li	a0,0
    55de:	74a2                	ld	s1,40(sp)
    55e0:	6a42                	ld	s4,16(sp)
    55e2:	6aa2                	ld	s5,8(sp)
    55e4:	6b02                	ld	s6,0(sp)
    55e6:	a03d                	j	5614 <malloc+0xdc>
    55e8:	74a2                	ld	s1,40(sp)
    55ea:	6a42                	ld	s4,16(sp)
    55ec:	6aa2                	ld	s5,8(sp)
    55ee:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    55f0:	fae90fe3          	beq	s2,a4,55ae <malloc+0x76>
        p->s.size -= nunits;
    55f4:	4137073b          	subw	a4,a4,s3
    55f8:	c798                	sw	a4,8(a5)
        p += p->s.size;
    55fa:	02071693          	slli	a3,a4,0x20
    55fe:	01c6d713          	srli	a4,a3,0x1c
    5602:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5604:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5608:	00003717          	auipc	a4,0x3
    560c:	e8a73423          	sd	a0,-376(a4) # 8490 <freep>
      return (void*)(p + 1);
    5610:	01078513          	addi	a0,a5,16
  }
}
    5614:	70e2                	ld	ra,56(sp)
    5616:	7442                	ld	s0,48(sp)
    5618:	7902                	ld	s2,32(sp)
    561a:	69e2                	ld	s3,24(sp)
    561c:	6121                	addi	sp,sp,64
    561e:	8082                	ret
    5620:	74a2                	ld	s1,40(sp)
    5622:	6a42                	ld	s4,16(sp)
    5624:	6aa2                	ld	s5,8(sp)
    5626:	6b02                	ld	s6,0(sp)
    5628:	b7f5                	j	5614 <malloc+0xdc>
