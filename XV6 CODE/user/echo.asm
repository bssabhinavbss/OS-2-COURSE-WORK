...
main(int argc, char *argv[])
{
  ...
  38:	94cb0b13          	addi	s6,s6,-1716 # 980 <malloc+0x100>
  ...
  6c:	92058593          	addi	a1,a1,-1760 # 988 <malloc+0x108>
  70:	8532                	mv	a0,a2
...
00000000000003fa <getchildsyscount>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 466:	53680813          	addi	a6,a6,1334 # 998 <digits>
 46a:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e8:	2ac48493          	addi	s1,s1,684 # 990 <malloc+0x110>
        for(; *s; s++)
